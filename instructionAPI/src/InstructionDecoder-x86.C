...
namespace Dyninst { namespace InstructionAPI {
  ...
  bool readsOperand(unsigned int opsema, unsigned int i) {
    switch(opsema) {
      case s1R2R: return (i == 0 || i == 1);
      case s1R:
      case s1RW: return i == 0;
      case s1W: return false;
      case s1W2RW:
      ...
      case s1R2R3R: return i == 0 || i == 1 || i == 2;
      case s1W2R3R4R: return i == 1 || i == 2 || i == 3;
      case s1RW2R3R4R: return i == 0 || i == 1 || i == 2 || i == 3;
      case sNONE: return false;
      default:
        return false;
        // printf("OPSEMA: %d\n", opsema);
  ...
  bool writesOperand(unsigned int opsema, unsigned int i) {
    switch(opsema) {
      ...
      case s1W2R3R:  // e.g. imul
      case s1RW2R3R: // shld/shrd
      case s1RW2R3R4R: return i == 0;
      case s1R2RW: return i == 1;
      case s1W2RW:
      case s1RW2RW:   // e.g. xchg
      case s1W2RW3R:  // some mul
      case s1W2W3R:   // e.g. les
  ...
  Expression::Ptr InstructionDecoder_x86::makeSIBExpression(const InstructionDecoder::buffer& b) {
    ...
    Expression::Ptr indexAST(boost::make_shared<RegisterAST>(makeRegisterID(index, op_type, locs->rex_x)));
    Expression::Ptr baseAST;
    if(base == 0x05) {
      switch(locs->modrm_mod) {
        case 0x00: baseAST = decodeImmediate(op_d, b.start + locs->sib_position + 1, true); break;
        case 0x01:
        case 0x02:
  ...
  Expression::Ptr InstructionDecoder_x86::makeModRMExpression(const InstructionDecoder::buffer& b,
    ...
    Expression::Ptr e = makeRegisterExpression(makeRegisterID(locs->modrm_rm, regType, locs->rex_b));
    switch(locs->modrm_mod) {
      case 0:
      ...
      case 2:
        ...
        return makeDereferenceExpression(e, makeSizeType(opType));
      case 3: return makeRegisterExpression(makeRegisterID(locs->modrm_rm, opType, locs->rex_b));
      default:
  ...
  Expression::Ptr InstructionDecoder_x86::decodeImmediate(unsigned int opType, const unsigned char* immStart,
    ...
    switch(opType) {
      ...
      case op_c:
        ...
        return Expression::Ptr();
      default: assert(!"Can't happen: opType out of range"); return Expression::Ptr();
    }
  }
  ...
  Expression::Ptr InstructionDecoder_x86::getModRMDisplacement(const InstructionDecoder::buffer& b) {
    ...
    switch(locs->modrm_mod) {
      case 1:
        return boost::make_shared<Immediate>(Result(s8, Dyninst::read_memory_as<byte_t>(b.start + disp_pos)));
        break;
      case 2:
      ...
      default: assert(b.start + disp_pos + 1 <= b.end); return boost::make_shared<Immediate>(Result(s8, 0));
    }
  }
  ...
  static MachRegister IntelRegTable32[][8] = {
      ...
      {x86::xmm0, x86::xmm1, x86::xmm2, x86::xmm3, x86::xmm4, x86::xmm5, x86::xmm6,
       x86::xmm7}, /* b_xmm_set0 */
      {x86_64::xmm8, x86_64::xmm9, x86_64::xmm10, x86_64::xmm11, x86_64::xmm12, x86_64::xmm13, x86_64::xmm14,
       x86_64::xmm15}, /* b_xmm_set1 */
      ...
      {x86_64::ymm0, x86_64::ymm1, x86_64::ymm2, x86_64::ymm3, x86_64::ymm4, x86_64::ymm5, x86_64::ymm6,
       x86_64::ymm7}, /* b_ymm_set0 */
      {x86_64::ymm8, x86_64::ymm9, x86_64::ymm10, x86_64::ymm11, x86_64::ymm12, x86_64::ymm13, x86_64::ymm14,
       x86_64::ymm15}, /* b_ymm_set1 */
      ...
      {x86_64::zmm0, x86_64::zmm1, x86_64::zmm2, x86_64::zmm3, x86_64::zmm4, x86_64::zmm5, x86_64::zmm6,
       x86_64::zmm7}, /* b_zmm_set0 */
      {x86_64::zmm8, x86_64::zmm9, x86_64::zmm10, x86_64::zmm11, x86_64::zmm12, x86_64::zmm13, x86_64::zmm14,
       x86_64::zmm15}, /* b_zmm_set1 */
  ...
  static MachRegister IntelRegTable64[][8] = {
      ...
      {x86_64::rax, x86_64::rcx, x86_64::rdx, x86_64::rbx, x86_64::rsp, x86_64::rbp, x86_64::rsi,
       x86_64::rdi},
      {x86_64::xmm0, x86_64::xmm1, x86_64::xmm2, x86_64::xmm3, x86_64::xmm4, x86_64::xmm5, x86_64::xmm6,
       x86_64::xmm7}, /* b_xmm_set0 */
      {x86_64::xmm8, x86_64::xmm9, x86_64::xmm10, x86_64::xmm11, x86_64::xmm12, x86_64::xmm13, x86_64::xmm14,
       x86_64::xmm15}, /* b_xmm_set1 */
      {x86_64::xmm16, x86_64::xmm17, x86_64::xmm18, x86_64::xmm19, x86_64::xmm20, x86_64::xmm21,
       x86_64::xmm22, x86_64::xmm23}, /* b_xmm_set2 */
      ...
      {x86_64::st0, x86_64::st1, x86_64::st2, x86_64::st3, x86_64::st4, x86_64::st5, x86_64::st6,
       x86_64::st7},
      {x86_64::r8b, x86_64::r9b, x86_64::r10b, x86_64::r11b, x86_64::r12b, x86_64::r13b, x86_64::r14b,
       x86_64::r15b},
      {x86_64::r8w, x86_64::r9w, x86_64::r10w, x86_64::r11w, x86_64::r12w, x86_64::r13w, x86_64::r14w,
       x86_64::r15w},
      {x86_64::r8d, x86_64::r9d, x86_64::r10d, x86_64::r11d, x86_64::r12d, x86_64::r13d, x86_64::r14d,
       x86_64::r15d},
  };
  ...
  MachRegister InstructionDecoder_x86::makeRegisterID(unsigned int intelReg, unsigned int opType,
    ...
    if(isExtendedReg) {
      switch(opType) {
        case op_q: retVal = IntelRegTable(m_Arch, b_amd64ext, intelReg); break;
        case op_d: retVal = IntelRegTable(m_Arch, amd64_ext_32, intelReg); break;
        case op_w: retVal = IntelRegTable(m_Arch, amd64_ext_16, intelReg); break;
        case op_b: retVal = IntelRegTable(m_Arch, amd64_ext_8, intelReg); break;
        case op_v:
          if(locs->rex_w || isDefault64Insn())
    ...
    */
      ...
      switch(opType) {
        ...
        case op_b:
          ...
          break;
        case op_q: retVal = IntelRegTable(m_Arch, b_64bit, intelReg); break;
        case op_w: retVal = IntelRegTable(m_Arch, b_16bit, intelReg); break;
        case op_f:
        case op_dbl: retVal = IntelRegTable(m_Arch, b_fpstack, intelReg); break;
        case op_d:
        case op_si: retVal = IntelRegTable(m_Arch, b_32bit, intelReg); break;
        default: retVal = IntelRegTable(m_Arch, b_32bit, intelReg); break;
      }
    }
  ...
  Result_Type InstructionDecoder_x86::makeSizeType(unsigned int opType) {
    switch(opType) {
      ...
      case op_ss:
      case op_allgprs:
      case op_si: return u32;
      case op_w:
      case op_a: return u16;
      case op_q:
      case op_sd: return u64;
      case op_v:
      case op_lea:
      case op_z:
        if(locs->rex_w) {
      ...
      case op_dq:
      case op_qq: return u64;
      case op_512: return m512;
      case op_pi:
      case op_ps:
      case op_pd: return dbl128;
      case op_s: return u48;
      case op_f: return sp_float;
      case op_dbl: return dp_float;
      case op_14: return m14;
      default: assert(!"Can't happen!"); return u8;
    }
  }
...
#define AVX_TYPE_OKAY(type) ((type) >= AVX_XMM && (type) <= AVX_ZMM)
   ...
   */
  bool decodeAVX(intelRegBanks& bank, int* bank_index, int regnum, AVX_Regtype type, ia32_prefixes& pref,
                 unsigned int admet, bool is64BitMode) {
    bool is64BitReg;
      ...
      case am_XV:
        switch(pref.vex_type) {
          case VEX_TYPE_EVEX:
            ...
            break;
          case VEX_TYPE_VEX2:
          case VEX_TYPE_VEX3: regnum |= pref.vex_r << 3; break;
          default: break;
        }
        break;
  ...
  bool InstructionDecoder_x86::decodeOneOperand(const InstructionDecoder::buffer& b,
    ...
    switch(operand.admet) {
      ...
      case am_B: {
        ...
        /* Append the operand */
        insn_to_complete->appendOperand(makeRegisterExpression(IntelRegTable(m_Arch, bank, bank_index)),
      ...
      case am_RM:
        if(isCFT) {
          ...
          insn_to_complete->appendOperand(makeModRMExpression(b, optype), isRead, isWritten, isImplicit);
        }
        break;
      ...
      case am_L:
        ...
        if(decodeAVX(bank, &bank_index, (*(const uint8_t*)(b.start + locs->imm_position[imm_index++])) >> 4,
      ...
      case am_I:
        insn_to_complete->appendOperand(decodeImmediate(optype, b.start + locs->imm_position[imm_index++]),
                                        isRead, isWritten, isImplicit);
        break;
      case am_J: {
      ...
      case am_O: {
        ...
        switch(locs->address_size) {
          case 1: pseudoOpType = op_b; break;
          case 2: pseudoOpType = op_w; break;
          case 4: pseudoOpType = op_d; break;
          case 0:
      ...
      case am_Q:
        switch(locs->modrm_mod) {
          ...
          case 0x03:
            ...
            insn_to_complete->appendOperand(
                makeRegisterExpression(IntelRegTable(m_Arch, b_mm, locs->modrm_rm)), isRead, isWritten,
                isImplicit);
            break;
          default: assert(!"2-bit value modrm_mod out of range"); break;
        };
        break;
      ...
      case am_S:
        ...
        insn_to_complete->appendOperand(
            makeRegisterExpression(IntelRegTable(m_Arch, b_segment, locs->modrm_reg)), isRead, isWritten,
            isImplicit);
        break;
      case am_T:
      ...
      case am_X: {
        ...
        insn_to_complete->appendOperand(makeDereferenceExpression(ds_si, makeSizeType(optype)), isRead,
      ...
      case am_Y: {
        ...
        insn_to_complete->appendOperand(makeDereferenceExpression(es_di, makeSizeType(optype)), isRead,
                                        isWritten, isImplicit);
          ...
          if(insn_to_complete->m_Operands.empty() &&
            ...
            if(locs->rex_b) {
              ...
              if(r.regClass() == (unsigned)x86::GPR) {
                ...
                switch(size) {
                  case 1: reg_op_type = op_b; break;
                  case 2: reg_op_type = op_w; break;
                  case 8: reg_op_type = op_q; break;
                  default: break;
                }
      ...
      case am_allgprs:
        ...
        break;
      case am_ImplImm:
        insn_to_complete->appendOperand(Immediate::makeImmediate(Result(makeSizeType(optype), 1)), isRead,
                                        isWritten, isImplicit);
        break;
      default:
    ...
    if(decodedInstruction->getEntry()) {
      ...
      if(decodedInstruction->getPrefix()->getPrefix(0) == PREFIX_LOCK) {
        switch(decodedInstruction->getEntry()->id) {
          ...
          case e_xadd:
          case e_xchg: break;
          default: m_Operation = Operation(&invalid, decodedInstruction->getPrefix(), locs, m_Arch); return;
        }
      ...
      m_Operation = Operation(decodedInstruction->getEntry(), decodedInstruction->getPrefix(), locs, m_Arch);
  ...
  bool InstructionDecoder_x86::decodeOperands(const Instruction* insn_to_complete) {
    ...
    if(decodedInstruction->getEntry()->getID() == e_ret_near ||
      ...
      Expression::Ptr ret_addr = makeDereferenceExpression(
          makeRegisterExpression(is64BitMode ? x86_64::rsp : x86::esp), is64BitMode ? u64 : u32);
    ...
    for(int i = 0; i < 3; i++) {
      ...
      if(!decodeOneOperand(b, decodedInstruction->getEntry()->operands[i], imm_index, insn_to_complete,
                           readsOperand(semantics, i), writesOperand(semantics, i),
    ...
    if(semantics >= s4OP) {
      if(decodedInstruction->getEntry()->operands[3].admet != 0 ||
        ...
        if(!decodeOneOperand(b, decodedInstruction->getEntry()->operands[3], imm_index, insn_to_complete,
                             readsOperand(semantics, 3), writesOperand(semantics, 3),
