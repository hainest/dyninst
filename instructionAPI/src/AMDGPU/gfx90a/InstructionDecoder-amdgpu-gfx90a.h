 ...
 */
#ifndef INSTRUCTION_DECODER_GFX90A_H
#define INSTRUCTION_DECODER_GFX90A_H
#include <array>
#include <stddef.h>
#include <stdint.h>
#include <string>
...
#define insn_printf(format, ...) \
        ...
        class InstructionDecoder_amdgpu_gfx90a : public InstructionDecoderImpl {
            ...
            const amdgpu_gfx90a_insn_entry ENC_DS_insn_table[256] = 
            {
                {amdgpu_gfx90a_op_DS_ADD_U32,"DS_ADD_U32"}, // 0
                {amdgpu_gfx90a_op_DS_SUB_U32,"DS_SUB_U32"}, // 1
                {amdgpu_gfx90a_op_DS_RSUB_U32,"DS_RSUB_U32"}, // 2
                {amdgpu_gfx90a_op_DS_INC_U32,"DS_INC_U32"}, // 3
                {amdgpu_gfx90a_op_DS_DEC_U32,"DS_DEC_U32"}, // 4
                {amdgpu_gfx90a_op_DS_MIN_I32,"DS_MIN_I32"}, // 5
                {amdgpu_gfx90a_op_DS_MAX_I32,"DS_MAX_I32"}, // 6
                {amdgpu_gfx90a_op_DS_MIN_U32,"DS_MIN_U32"}, // 7
                {amdgpu_gfx90a_op_DS_MAX_U32,"DS_MAX_U32"}, // 8
                {amdgpu_gfx90a_op_DS_AND_B32,"DS_AND_B32"}, // 9
                {amdgpu_gfx90a_op_DS_OR_B32,"DS_OR_B32"}, // 10
                {amdgpu_gfx90a_op_DS_XOR_B32,"DS_XOR_B32"}, // 11
                {amdgpu_gfx90a_op_DS_MSKOR_B32,"DS_MSKOR_B32"}, // 12
                {amdgpu_gfx90a_op_DS_WRITE_B32,"DS_WRITE_B32"}, // 13
                {amdgpu_gfx90a_op_DS_WRITE2_B32,"DS_WRITE2_B32"}, // 14
                {amdgpu_gfx90a_op_DS_WRITE2ST64_B32,"DS_WRITE2ST64_B32"}, // 15
                {amdgpu_gfx90a_op_DS_CMPST_B32,"DS_CMPST_B32"}, // 16
                {amdgpu_gfx90a_op_DS_CMPST_F32,"DS_CMPST_F32"}, // 17
                {amdgpu_gfx90a_op_DS_MIN_F32,"DS_MIN_F32"}, // 18
                ...
                {amdgpu_gfx90a_op_DS_ADD_RTN_U32,"DS_ADD_RTN_U32"}, // 32
                {amdgpu_gfx90a_op_DS_SUB_RTN_U32,"DS_SUB_RTN_U32"}, // 33
                {amdgpu_gfx90a_op_DS_RSUB_RTN_U32,"DS_RSUB_RTN_U32"}, // 34
                {amdgpu_gfx90a_op_DS_INC_RTN_U32,"DS_INC_RTN_U32"}, // 35
                {amdgpu_gfx90a_op_DS_DEC_RTN_U32,"DS_DEC_RTN_U32"}, // 36
                {amdgpu_gfx90a_op_DS_MIN_RTN_I32,"DS_MIN_RTN_I32"}, // 37
                {amdgpu_gfx90a_op_DS_MAX_RTN_I32,"DS_MAX_RTN_I32"}, // 38
                {amdgpu_gfx90a_op_DS_MIN_RTN_U32,"DS_MIN_RTN_U32"}, // 39
                {amdgpu_gfx90a_op_DS_MAX_RTN_U32,"DS_MAX_RTN_U32"}, // 40
                {amdgpu_gfx90a_op_DS_AND_RTN_B32,"DS_AND_RTN_B32"}, // 41
                {amdgpu_gfx90a_op_DS_OR_RTN_B32,"DS_OR_RTN_B32"}, // 42
                {amdgpu_gfx90a_op_DS_XOR_RTN_B32,"DS_XOR_RTN_B32"}, // 43
                {amdgpu_gfx90a_op_DS_MSKOR_RTN_B32,"DS_MSKOR_RTN_B32"}, // 44
                {amdgpu_gfx90a_op_DS_WRXCHG_RTN_B32,"DS_WRXCHG_RTN_B32"}, // 45
                {amdgpu_gfx90a_op_DS_WRXCHG2_RTN_B32,"DS_WRXCHG2_RTN_B32"}, // 46
                {amdgpu_gfx90a_op_DS_WRXCHG2ST64_RTN_B32,"DS_WRXCHG2ST64_RTN_B32"}, // 47
                {amdgpu_gfx90a_op_DS_CMPST_RTN_B32,"DS_CMPST_RTN_B32"}, // 48
                {amdgpu_gfx90a_op_DS_CMPST_RTN_F32,"DS_CMPST_RTN_F32"}, // 49
                {amdgpu_gfx90a_op_DS_MIN_RTN_F32,"DS_MIN_RTN_F32"}, // 50
                {amdgpu_gfx90a_op_DS_MAX_RTN_F32,"DS_MAX_RTN_F32"}, // 51
                {amdgpu_gfx90a_op_DS_WRAP_RTN_B32,"DS_WRAP_RTN_B32"}, // 52
                {amdgpu_gfx90a_op_DS_ADD_RTN_F32,"DS_ADD_RTN_F32"}, // 53
                {amdgpu_gfx90a_op_DS_READ_B32,"DS_READ_B32"}, // 54
                {amdgpu_gfx90a_op_DS_READ2_B32,"DS_READ2_B32"}, // 55
                {amdgpu_gfx90a_op_DS_READ2ST64_B32,"DS_READ2ST64_B32"}, // 56
                {amdgpu_gfx90a_op_DS_READ_I8,"DS_READ_I8"}, // 57
                {amdgpu_gfx90a_op_DS_READ_U8,"DS_READ_U8"}, // 58
                {amdgpu_gfx90a_op_DS_READ_I16,"DS_READ_I16"}, // 59
                {amdgpu_gfx90a_op_DS_READ_U16,"DS_READ_U16"}, // 60
                {amdgpu_gfx90a_op_DS_SWIZZLE_B32,"DS_SWIZZLE_B32"}, // 61
                {amdgpu_gfx90a_op_DS_PERMUTE_B32,"DS_PERMUTE_B32"}, // 62
                {amdgpu_gfx90a_op_DS_BPERMUTE_B32,"DS_BPERMUTE_B32"}, // 63
                {amdgpu_gfx90a_op_DS_ADD_U64,"DS_ADD_U64"}, // 64
                {amdgpu_gfx90a_op_DS_SUB_U64,"DS_SUB_U64"}, // 65
                {amdgpu_gfx90a_op_DS_RSUB_U64,"DS_RSUB_U64"}, // 66
                {amdgpu_gfx90a_op_DS_INC_U64,"DS_INC_U64"}, // 67
                {amdgpu_gfx90a_op_DS_DEC_U64,"DS_DEC_U64"}, // 68
                {amdgpu_gfx90a_op_DS_MIN_I64,"DS_MIN_I64"}, // 69
                {amdgpu_gfx90a_op_DS_MAX_I64,"DS_MAX_I64"}, // 70
                {amdgpu_gfx90a_op_DS_MIN_U64,"DS_MIN_U64"}, // 71
                {amdgpu_gfx90a_op_DS_MAX_U64,"DS_MAX_U64"}, // 72
                {amdgpu_gfx90a_op_DS_AND_B64,"DS_AND_B64"}, // 73
                {amdgpu_gfx90a_op_DS_OR_B64,"DS_OR_B64"}, // 74
                {amdgpu_gfx90a_op_DS_XOR_B64,"DS_XOR_B64"}, // 75
                {amdgpu_gfx90a_op_DS_MSKOR_B64,"DS_MSKOR_B64"}, // 76
                {amdgpu_gfx90a_op_DS_WRITE_B64,"DS_WRITE_B64"}, // 77
                {amdgpu_gfx90a_op_DS_WRITE2_B64,"DS_WRITE2_B64"}, // 78
                {amdgpu_gfx90a_op_DS_WRITE2ST64_B64,"DS_WRITE2ST64_B64"}, // 79
                {amdgpu_gfx90a_op_DS_CMPST_B64,"DS_CMPST_B64"}, // 80
                {amdgpu_gfx90a_op_DS_CMPST_F64,"DS_CMPST_F64"}, // 81
                {amdgpu_gfx90a_op_DS_MIN_F64,"DS_MIN_F64"}, // 82
                {amdgpu_gfx90a_op_DS_MAX_F64,"DS_MAX_F64"}, // 83
                {amdgpu_gfx90a_op_DS_WRITE_B8_D16_HI,"DS_WRITE_B8_D16_HI"}, // 84
                {amdgpu_gfx90a_op_DS_WRITE_B16_D16_HI,"DS_WRITE_B16_D16_HI"}, // 85
                {amdgpu_gfx90a_op_DS_READ_U8_D16,"DS_READ_U8_D16"}, // 86
                {amdgpu_gfx90a_op_DS_READ_U8_D16_HI,"DS_READ_U8_D16_HI"}, // 87
                {amdgpu_gfx90a_op_DS_READ_I8_D16,"DS_READ_I8_D16"}, // 88
                {amdgpu_gfx90a_op_DS_READ_I8_D16_HI,"DS_READ_I8_D16_HI"}, // 89
                ...
                {amdgpu_gfx90a_op_DS_INC_RTN_U64,"DS_INC_RTN_U64"}, // 99
                {amdgpu_gfx90a_op_DS_DEC_RTN_U64,"DS_DEC_RTN_U64"}, // 100
                {amdgpu_gfx90a_op_DS_MIN_RTN_I64,"DS_MIN_RTN_I64"}, // 101
                {amdgpu_gfx90a_op_DS_MAX_RTN_I64,"DS_MAX_RTN_I64"}, // 102
                {amdgpu_gfx90a_op_DS_MIN_RTN_U64,"DS_MIN_RTN_U64"}, // 103
                {amdgpu_gfx90a_op_DS_MAX_RTN_U64,"DS_MAX_RTN_U64"}, // 104
                {amdgpu_gfx90a_op_DS_AND_RTN_B64,"DS_AND_RTN_B64"}, // 105
                {amdgpu_gfx90a_op_DS_OR_RTN_B64,"DS_OR_RTN_B64"}, // 106
                {amdgpu_gfx90a_op_DS_XOR_RTN_B64,"DS_XOR_RTN_B64"}, // 107
                {amdgpu_gfx90a_op_DS_MSKOR_RTN_B64,"DS_MSKOR_RTN_B64"}, // 108
                {amdgpu_gfx90a_op_DS_WRXCHG_RTN_B64,"DS_WRXCHG_RTN_B64"}, // 109
                {amdgpu_gfx90a_op_DS_WRXCHG2_RTN_B64,"DS_WRXCHG2_RTN_B64"}, // 110
                {amdgpu_gfx90a_op_DS_WRXCHG2ST64_RTN_B64,"DS_WRXCHG2ST64_RTN_B64"}, // 111
                {amdgpu_gfx90a_op_DS_CMPST_RTN_B64,"DS_CMPST_RTN_B64"}, // 112
            ...
            const amdgpu_gfx90a_insn_entry ENC_FLAT_insn_table[109] = 
            {
                ...
                {amdgpu_gfx90a_op_FLAT_LOAD_SSHORT,"FLAT_LOAD_SSHORT"}, // 19
                {amdgpu_gfx90a_op_FLAT_LOAD_DWORD,"FLAT_LOAD_DWORD"}, // 20
                {amdgpu_gfx90a_op_FLAT_LOAD_DWORDX2,"FLAT_LOAD_DWORDX2"}, // 21
                {amdgpu_gfx90a_op_FLAT_LOAD_DWORDX3,"FLAT_LOAD_DWORDX3"}, // 22
                {amdgpu_gfx90a_op_FLAT_LOAD_DWORDX4,"FLAT_LOAD_DWORDX4"}, // 23
                {amdgpu_gfx90a_op_FLAT_STORE_BYTE,"FLAT_STORE_BYTE"}, // 24
                {amdgpu_gfx90a_op_FLAT_STORE_BYTE_D16_HI,"FLAT_STORE_BYTE_D16_HI"}, // 25
                {amdgpu_gfx90a_op_FLAT_STORE_SHORT,"FLAT_STORE_SHORT"}, // 26
                {amdgpu_gfx90a_op_FLAT_STORE_SHORT_D16_HI,"FLAT_STORE_SHORT_D16_HI"}, // 27
                {amdgpu_gfx90a_op_FLAT_STORE_DWORD,"FLAT_STORE_DWORD"}, // 28
                {amdgpu_gfx90a_op_FLAT_STORE_DWORDX2,"FLAT_STORE_DWORDX2"}, // 29
                {amdgpu_gfx90a_op_FLAT_STORE_DWORDX3,"FLAT_STORE_DWORDX3"}, // 30
                {amdgpu_gfx90a_op_FLAT_STORE_DWORDX4,"FLAT_STORE_DWORDX4"}, // 31
                {amdgpu_gfx90a_op_FLAT_LOAD_UBYTE_D16,"FLAT_LOAD_UBYTE_D16"}, // 32
                {amdgpu_gfx90a_op_FLAT_LOAD_UBYTE_D16_HI,"FLAT_LOAD_UBYTE_D16_HI"}, // 33
                {amdgpu_gfx90a_op_FLAT_LOAD_SBYTE_D16,"FLAT_LOAD_SBYTE_D16"}, // 34
                ...
                {amdgpu_gfx90a_op_FLAT_ATOMIC_SUB,"FLAT_ATOMIC_SUB"}, // 67
                {amdgpu_gfx90a_op_FLAT_ATOMIC_SMIN,"FLAT_ATOMIC_SMIN"}, // 68
                {amdgpu_gfx90a_op_FLAT_ATOMIC_UMIN,"FLAT_ATOMIC_UMIN"}, // 69
                {amdgpu_gfx90a_op_FLAT_ATOMIC_SMAX,"FLAT_ATOMIC_SMAX"}, // 70
                {amdgpu_gfx90a_op_FLAT_ATOMIC_UMAX,"FLAT_ATOMIC_UMAX"}, // 71
                {amdgpu_gfx90a_op_FLAT_ATOMIC_AND,"FLAT_ATOMIC_AND"}, // 72
                {amdgpu_gfx90a_op_FLAT_ATOMIC_OR,"FLAT_ATOMIC_OR"}, // 73
                ...
                {amdgpu_gfx90a_op_FLAT_ATOMIC_SUB_X2,"FLAT_ATOMIC_SUB_X2"}, // 99
                {amdgpu_gfx90a_op_FLAT_ATOMIC_SMIN_X2,"FLAT_ATOMIC_SMIN_X2"}, // 100
                {amdgpu_gfx90a_op_FLAT_ATOMIC_UMIN_X2,"FLAT_ATOMIC_UMIN_X2"}, // 101
                {amdgpu_gfx90a_op_FLAT_ATOMIC_SMAX_X2,"FLAT_ATOMIC_SMAX_X2"}, // 102
                {amdgpu_gfx90a_op_FLAT_ATOMIC_UMAX_X2,"FLAT_ATOMIC_UMAX_X2"}, // 103
                {amdgpu_gfx90a_op_FLAT_ATOMIC_AND_X2,"FLAT_ATOMIC_AND_X2"}, // 104
                {amdgpu_gfx90a_op_FLAT_ATOMIC_OR_X2,"FLAT_ATOMIC_OR_X2"}, // 105
                {amdgpu_gfx90a_op_FLAT_ATOMIC_XOR_X2,"FLAT_ATOMIC_XOR_X2"}, // 106
                {amdgpu_gfx90a_op_FLAT_ATOMIC_INC_X2,"FLAT_ATOMIC_INC_X2"}, // 107
                {amdgpu_gfx90a_op_FLAT_ATOMIC_DEC_X2,"FLAT_ATOMIC_DEC_X2"}, // 108
            ...
            const amdgpu_gfx90a_insn_entry ENC_FLAT_GLBL_insn_table[109] = 
            {
                ...
                {amdgpu_gfx90a_op_GLOBAL_LOAD_SSHORT,"GLOBAL_LOAD_SSHORT"}, // 19
                {amdgpu_gfx90a_op_GLOBAL_LOAD_DWORD,"GLOBAL_LOAD_DWORD"}, // 20
                {amdgpu_gfx90a_op_GLOBAL_LOAD_DWORDX2,"GLOBAL_LOAD_DWORDX2"}, // 21
                {amdgpu_gfx90a_op_GLOBAL_LOAD_DWORDX3,"GLOBAL_LOAD_DWORDX3"}, // 22
                {amdgpu_gfx90a_op_GLOBAL_LOAD_DWORDX4,"GLOBAL_LOAD_DWORDX4"}, // 23
                {amdgpu_gfx90a_op_GLOBAL_STORE_BYTE,"GLOBAL_STORE_BYTE"}, // 24
                {amdgpu_gfx90a_op_GLOBAL_STORE_BYTE_D16_HI,"GLOBAL_STORE_BYTE_D16_HI"}, // 25
                {amdgpu_gfx90a_op_GLOBAL_STORE_SHORT,"GLOBAL_STORE_SHORT"}, // 26
                {amdgpu_gfx90a_op_GLOBAL_STORE_SHORT_D16_HI,"GLOBAL_STORE_SHORT_D16_HI"}, // 27
                {amdgpu_gfx90a_op_GLOBAL_STORE_DWORD,"GLOBAL_STORE_DWORD"}, // 28
                {amdgpu_gfx90a_op_GLOBAL_STORE_DWORDX2,"GLOBAL_STORE_DWORDX2"}, // 29
                {amdgpu_gfx90a_op_GLOBAL_STORE_DWORDX3,"GLOBAL_STORE_DWORDX3"}, // 30
                {amdgpu_gfx90a_op_GLOBAL_STORE_DWORDX4,"GLOBAL_STORE_DWORDX4"}, // 31
                {amdgpu_gfx90a_op_GLOBAL_LOAD_UBYTE_D16,"GLOBAL_LOAD_UBYTE_D16"}, // 32
                {amdgpu_gfx90a_op_GLOBAL_LOAD_UBYTE_D16_HI,"GLOBAL_LOAD_UBYTE_D16_HI"}, // 33
                {amdgpu_gfx90a_op_GLOBAL_LOAD_SBYTE_D16,"GLOBAL_LOAD_SBYTE_D16"}, // 34
                ...
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_SUB,"GLOBAL_ATOMIC_SUB"}, // 67
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_SMIN,"GLOBAL_ATOMIC_SMIN"}, // 68
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_UMIN,"GLOBAL_ATOMIC_UMIN"}, // 69
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_SMAX,"GLOBAL_ATOMIC_SMAX"}, // 70
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_UMAX,"GLOBAL_ATOMIC_UMAX"}, // 71
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_AND,"GLOBAL_ATOMIC_AND"}, // 72
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_OR,"GLOBAL_ATOMIC_OR"}, // 73
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_XOR,"GLOBAL_ATOMIC_XOR"}, // 74
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_INC,"GLOBAL_ATOMIC_INC"}, // 75
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_DEC,"GLOBAL_ATOMIC_DEC"}, // 76
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_ADD_F32,"GLOBAL_ATOMIC_ADD_F32"}, // 77
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_PK_ADD_F16,"GLOBAL_ATOMIC_PK_ADD_F16"}, // 78
                ...
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_SUB_X2,"GLOBAL_ATOMIC_SUB_X2"}, // 99
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_SMIN_X2,"GLOBAL_ATOMIC_SMIN_X2"}, // 100
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_UMIN_X2,"GLOBAL_ATOMIC_UMIN_X2"}, // 101
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_SMAX_X2,"GLOBAL_ATOMIC_SMAX_X2"}, // 102
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_UMAX_X2,"GLOBAL_ATOMIC_UMAX_X2"}, // 103
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_AND_X2,"GLOBAL_ATOMIC_AND_X2"}, // 104
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_OR_X2,"GLOBAL_ATOMIC_OR_X2"}, // 105
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_XOR_X2,"GLOBAL_ATOMIC_XOR_X2"}, // 106
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_INC_X2,"GLOBAL_ATOMIC_INC_X2"}, // 107
                {amdgpu_gfx90a_op_GLOBAL_ATOMIC_DEC_X2,"GLOBAL_ATOMIC_DEC_X2"}, // 108
            ...
            const amdgpu_gfx90a_insn_entry ENC_FLAT_SCRATCH_insn_table[38] = 
            {
                ...
                {amdgpu_gfx90a_op_SCRATCH_LOAD_SSHORT,"SCRATCH_LOAD_SSHORT"}, // 19
                {amdgpu_gfx90a_op_SCRATCH_LOAD_DWORD,"SCRATCH_LOAD_DWORD"}, // 20
                {amdgpu_gfx90a_op_SCRATCH_LOAD_DWORDX2,"SCRATCH_LOAD_DWORDX2"}, // 21
                {amdgpu_gfx90a_op_SCRATCH_LOAD_DWORDX3,"SCRATCH_LOAD_DWORDX3"}, // 22
                {amdgpu_gfx90a_op_SCRATCH_LOAD_DWORDX4,"SCRATCH_LOAD_DWORDX4"}, // 23
                {amdgpu_gfx90a_op_SCRATCH_STORE_BYTE,"SCRATCH_STORE_BYTE"}, // 24
                {amdgpu_gfx90a_op_SCRATCH_STORE_BYTE_D16_HI,"SCRATCH_STORE_BYTE_D16_HI"}, // 25
                {amdgpu_gfx90a_op_SCRATCH_STORE_SHORT,"SCRATCH_STORE_SHORT"}, // 26
                {amdgpu_gfx90a_op_SCRATCH_STORE_SHORT_D16_HI,"SCRATCH_STORE_SHORT_D16_HI"}, // 27
                {amdgpu_gfx90a_op_SCRATCH_STORE_DWORD,"SCRATCH_STORE_DWORD"}, // 28
                {amdgpu_gfx90a_op_SCRATCH_STORE_DWORDX2,"SCRATCH_STORE_DWORDX2"}, // 29
                {amdgpu_gfx90a_op_SCRATCH_STORE_DWORDX3,"SCRATCH_STORE_DWORDX3"}, // 30
                {amdgpu_gfx90a_op_SCRATCH_STORE_DWORDX4,"SCRATCH_STORE_DWORDX4"}, // 31
                {amdgpu_gfx90a_op_SCRATCH_LOAD_UBYTE_D16,"SCRATCH_LOAD_UBYTE_D16"}, // 32
                {amdgpu_gfx90a_op_SCRATCH_LOAD_UBYTE_D16_HI,"SCRATCH_LOAD_UBYTE_D16_HI"}, // 33
                {amdgpu_gfx90a_op_SCRATCH_LOAD_SBYTE_D16,"SCRATCH_LOAD_SBYTE_D16"}, // 34
                {amdgpu_gfx90a_op_SCRATCH_LOAD_SBYTE_D16_HI,"SCRATCH_LOAD_SBYTE_D16_HI"}, // 35
                {amdgpu_gfx90a_op_SCRATCH_LOAD_SHORT_D16,"SCRATCH_LOAD_SHORT_D16"}, // 36
                {amdgpu_gfx90a_op_SCRATCH_LOAD_SHORT_D16_HI,"SCRATCH_LOAD_SHORT_D16_HI"}, // 37
            }; // end ENC_FLAT_SCRATCH_insn_table
            const amdgpu_gfx90a_insn_entry ENC_MIMG_insn_table[33] = 
            {
                {amdgpu_gfx90a_op_IMAGE_LOAD,"IMAGE_LOAD"}, // 0
                {amdgpu_gfx90a_op_IMAGE_LOAD_MIP,"IMAGE_LOAD_MIP"}, // 1
                {amdgpu_gfx90a_op_IMAGE_LOAD_PCK,"IMAGE_LOAD_PCK"}, // 2
                ...
                {amdgpu_gfx90a_op_IMAGE_ATOMIC_SUB,"IMAGE_ATOMIC_SUB"}, // 19
                {amdgpu_gfx90a_op_IMAGE_ATOMIC_SMIN,"IMAGE_ATOMIC_SMIN"}, // 20
                {amdgpu_gfx90a_op_IMAGE_ATOMIC_UMIN,"IMAGE_ATOMIC_UMIN"}, // 21
                {amdgpu_gfx90a_op_IMAGE_ATOMIC_SMAX,"IMAGE_ATOMIC_SMAX"}, // 22
                {amdgpu_gfx90a_op_IMAGE_ATOMIC_UMAX,"IMAGE_ATOMIC_UMAX"}, // 23
                {amdgpu_gfx90a_op_IMAGE_ATOMIC_AND,"IMAGE_ATOMIC_AND"}, // 24
                {amdgpu_gfx90a_op_IMAGE_ATOMIC_OR,"IMAGE_ATOMIC_OR"}, // 25
            ...
            {
                {amdgpu_gfx90a_op_TBUFFER_LOAD_FORMAT_X,"TBUFFER_LOAD_FORMAT_X"}, // 0
                {amdgpu_gfx90a_op_TBUFFER_LOAD_FORMAT_XY,"TBUFFER_LOAD_FORMAT_XY"}, // 1
                {amdgpu_gfx90a_op_TBUFFER_LOAD_FORMAT_XYZ,"TBUFFER_LOAD_FORMAT_XYZ"}, // 2
                {amdgpu_gfx90a_op_TBUFFER_LOAD_FORMAT_XYZW,"TBUFFER_LOAD_FORMAT_XYZW"}, // 3
                {amdgpu_gfx90a_op_TBUFFER_STORE_FORMAT_X,"TBUFFER_STORE_FORMAT_X"}, // 4
                {amdgpu_gfx90a_op_TBUFFER_STORE_FORMAT_XY,"TBUFFER_STORE_FORMAT_XY"}, // 5
                {amdgpu_gfx90a_op_TBUFFER_STORE_FORMAT_XYZ,"TBUFFER_STORE_FORMAT_XYZ"}, // 6
                {amdgpu_gfx90a_op_TBUFFER_STORE_FORMAT_XYZW,"TBUFFER_STORE_FORMAT_XYZW"}, // 7
                {amdgpu_gfx90a_op_TBUFFER_LOAD_FORMAT_D16_X,"TBUFFER_LOAD_FORMAT_D16_X"}, // 8
                {amdgpu_gfx90a_op_TBUFFER_LOAD_FORMAT_D16_XY,"TBUFFER_LOAD_FORMAT_D16_XY"}, // 9
                {amdgpu_gfx90a_op_TBUFFER_LOAD_FORMAT_D16_XYZ,"TBUFFER_LOAD_FORMAT_D16_XYZ"}, // 10
                {amdgpu_gfx90a_op_TBUFFER_LOAD_FORMAT_D16_XYZW,"TBUFFER_LOAD_FORMAT_D16_XYZW"}, // 11
                {amdgpu_gfx90a_op_TBUFFER_STORE_FORMAT_D16_X,"TBUFFER_STORE_FORMAT_D16_X"}, // 12
                {amdgpu_gfx90a_op_TBUFFER_STORE_FORMAT_D16_XY,"TBUFFER_STORE_FORMAT_D16_XY"}, // 13
                {amdgpu_gfx90a_op_TBUFFER_STORE_FORMAT_D16_XYZ,"TBUFFER_STORE_FORMAT_D16_XYZ"}, // 14
                {amdgpu_gfx90a_op_TBUFFER_STORE_FORMAT_D16_XYZW,"TBUFFER_STORE_FORMAT_D16_XYZW"}, // 15
            }; // end ENC_MTBUF_insn_table
            const amdgpu_gfx90a_insn_entry ENC_MUBUF_insn_table[109] = 
            {
                {amdgpu_gfx90a_op_BUFFER_LOAD_FORMAT_X,"BUFFER_LOAD_FORMAT_X"}, // 0
                {amdgpu_gfx90a_op_BUFFER_LOAD_FORMAT_XY,"BUFFER_LOAD_FORMAT_XY"}, // 1
                {amdgpu_gfx90a_op_BUFFER_LOAD_FORMAT_XYZ,"BUFFER_LOAD_FORMAT_XYZ"}, // 2
                {amdgpu_gfx90a_op_BUFFER_LOAD_FORMAT_XYZW,"BUFFER_LOAD_FORMAT_XYZW"}, // 3
                {amdgpu_gfx90a_op_BUFFER_STORE_FORMAT_X,"BUFFER_STORE_FORMAT_X"}, // 4
                {amdgpu_gfx90a_op_BUFFER_STORE_FORMAT_XY,"BUFFER_STORE_FORMAT_XY"}, // 5
                {amdgpu_gfx90a_op_BUFFER_STORE_FORMAT_XYZ,"BUFFER_STORE_FORMAT_XYZ"}, // 6
                {amdgpu_gfx90a_op_BUFFER_STORE_FORMAT_XYZW,"BUFFER_STORE_FORMAT_XYZW"}, // 7
                {amdgpu_gfx90a_op_BUFFER_LOAD_FORMAT_D16_X,"BUFFER_LOAD_FORMAT_D16_X"}, // 8
                {amdgpu_gfx90a_op_BUFFER_LOAD_FORMAT_D16_XY,"BUFFER_LOAD_FORMAT_D16_XY"}, // 9
                {amdgpu_gfx90a_op_BUFFER_LOAD_FORMAT_D16_XYZ,"BUFFER_LOAD_FORMAT_D16_XYZ"}, // 10
                {amdgpu_gfx90a_op_BUFFER_LOAD_FORMAT_D16_XYZW,"BUFFER_LOAD_FORMAT_D16_XYZW"}, // 11
                {amdgpu_gfx90a_op_BUFFER_STORE_FORMAT_D16_X,"BUFFER_STORE_FORMAT_D16_X"}, // 12
                {amdgpu_gfx90a_op_BUFFER_STORE_FORMAT_D16_XY,"BUFFER_STORE_FORMAT_D16_XY"}, // 13
                {amdgpu_gfx90a_op_BUFFER_STORE_FORMAT_D16_XYZ,"BUFFER_STORE_FORMAT_D16_XYZ"}, // 14
                {amdgpu_gfx90a_op_BUFFER_STORE_FORMAT_D16_XYZW,"BUFFER_STORE_FORMAT_D16_XYZW"}, // 15
                {amdgpu_gfx90a_op_BUFFER_LOAD_UBYTE,"BUFFER_LOAD_UBYTE"}, // 16
                {amdgpu_gfx90a_op_BUFFER_LOAD_SBYTE,"BUFFER_LOAD_SBYTE"}, // 17
                {amdgpu_gfx90a_op_BUFFER_LOAD_USHORT,"BUFFER_LOAD_USHORT"}, // 18
                {amdgpu_gfx90a_op_BUFFER_LOAD_SSHORT,"BUFFER_LOAD_SSHORT"}, // 19
                {amdgpu_gfx90a_op_BUFFER_LOAD_DWORD,"BUFFER_LOAD_DWORD"}, // 20
                {amdgpu_gfx90a_op_BUFFER_LOAD_DWORDX2,"BUFFER_LOAD_DWORDX2"}, // 21
                {amdgpu_gfx90a_op_BUFFER_LOAD_DWORDX3,"BUFFER_LOAD_DWORDX3"}, // 22
                {amdgpu_gfx90a_op_BUFFER_LOAD_DWORDX4,"BUFFER_LOAD_DWORDX4"}, // 23
                {amdgpu_gfx90a_op_BUFFER_STORE_BYTE,"BUFFER_STORE_BYTE"}, // 24
                {amdgpu_gfx90a_op_BUFFER_STORE_BYTE_D16_HI,"BUFFER_STORE_BYTE_D16_HI"}, // 25
                {amdgpu_gfx90a_op_BUFFER_STORE_SHORT,"BUFFER_STORE_SHORT"}, // 26
                {amdgpu_gfx90a_op_BUFFER_STORE_SHORT_D16_HI,"BUFFER_STORE_SHORT_D16_HI"}, // 27
                {amdgpu_gfx90a_op_BUFFER_STORE_DWORD,"BUFFER_STORE_DWORD"}, // 28
                {amdgpu_gfx90a_op_BUFFER_STORE_DWORDX2,"BUFFER_STORE_DWORDX2"}, // 29
                {amdgpu_gfx90a_op_BUFFER_STORE_DWORDX3,"BUFFER_STORE_DWORDX3"}, // 30
                {amdgpu_gfx90a_op_BUFFER_STORE_DWORDX4,"BUFFER_STORE_DWORDX4"}, // 31
                {amdgpu_gfx90a_op_BUFFER_LOAD_UBYTE_D16,"BUFFER_LOAD_UBYTE_D16"}, // 32
                {amdgpu_gfx90a_op_BUFFER_LOAD_UBYTE_D16_HI,"BUFFER_LOAD_UBYTE_D16_HI"}, // 33
                {amdgpu_gfx90a_op_BUFFER_LOAD_SBYTE_D16,"BUFFER_LOAD_SBYTE_D16"}, // 34
                {amdgpu_gfx90a_op_BUFFER_LOAD_SBYTE_D16_HI,"BUFFER_LOAD_SBYTE_D16_HI"}, // 35
                {amdgpu_gfx90a_op_BUFFER_LOAD_SHORT_D16,"BUFFER_LOAD_SHORT_D16"}, // 36
                {amdgpu_gfx90a_op_BUFFER_LOAD_SHORT_D16_HI,"BUFFER_LOAD_SHORT_D16_HI"}, // 37
                {amdgpu_gfx90a_op_BUFFER_LOAD_FORMAT_D16_HI_X,"BUFFER_LOAD_FORMAT_D16_HI_X"}, // 38
                ...
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_SWAP,"BUFFER_ATOMIC_SWAP"}, // 64
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_CMPSWAP,"BUFFER_ATOMIC_CMPSWAP"}, // 65
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_ADD,"BUFFER_ATOMIC_ADD"}, // 66
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_SUB,"BUFFER_ATOMIC_SUB"}, // 67
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_SMIN,"BUFFER_ATOMIC_SMIN"}, // 68
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_UMIN,"BUFFER_ATOMIC_UMIN"}, // 69
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_SMAX,"BUFFER_ATOMIC_SMAX"}, // 70
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_UMAX,"BUFFER_ATOMIC_UMAX"}, // 71
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_AND,"BUFFER_ATOMIC_AND"}, // 72
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_OR,"BUFFER_ATOMIC_OR"}, // 73
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_XOR,"BUFFER_ATOMIC_XOR"}, // 74
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_INC,"BUFFER_ATOMIC_INC"}, // 75
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_DEC,"BUFFER_ATOMIC_DEC"}, // 76
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_ADD_F32,"BUFFER_ATOMIC_ADD_F32"}, // 77
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_PK_ADD_F16,"BUFFER_ATOMIC_PK_ADD_F16"}, // 78
                ...
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_SUB_X2,"BUFFER_ATOMIC_SUB_X2"}, // 99
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_SMIN_X2,"BUFFER_ATOMIC_SMIN_X2"}, // 100
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_UMIN_X2,"BUFFER_ATOMIC_UMIN_X2"}, // 101
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_SMAX_X2,"BUFFER_ATOMIC_SMAX_X2"}, // 102
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_UMAX_X2,"BUFFER_ATOMIC_UMAX_X2"}, // 103
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_AND_X2,"BUFFER_ATOMIC_AND_X2"}, // 104
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_OR_X2,"BUFFER_ATOMIC_OR_X2"}, // 105
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_XOR_X2,"BUFFER_ATOMIC_XOR_X2"}, // 106
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_INC_X2,"BUFFER_ATOMIC_INC_X2"}, // 107
                {amdgpu_gfx90a_op_BUFFER_ATOMIC_DEC_X2,"BUFFER_ATOMIC_DEC_X2"}, // 108
            }; // end ENC_MUBUF_insn_table
            const amdgpu_gfx90a_insn_entry ENC_SMEM_insn_table[173] = 
            {
                {amdgpu_gfx90a_op_S_LOAD_DWORD,"S_LOAD_DWORD"}, // 0
                {amdgpu_gfx90a_op_S_LOAD_DWORDX2,"S_LOAD_DWORDX2"}, // 1
                {amdgpu_gfx90a_op_S_LOAD_DWORDX4,"S_LOAD_DWORDX4"}, // 2
                {amdgpu_gfx90a_op_S_LOAD_DWORDX8,"S_LOAD_DWORDX8"}, // 3
                {amdgpu_gfx90a_op_S_LOAD_DWORDX16,"S_LOAD_DWORDX16"}, // 4
                {amdgpu_gfx90a_op_S_SCRATCH_LOAD_DWORD,"S_SCRATCH_LOAD_DWORD"}, // 5
                {amdgpu_gfx90a_op_S_SCRATCH_LOAD_DWORDX2,"S_SCRATCH_LOAD_DWORDX2"}, // 6
                {amdgpu_gfx90a_op_S_SCRATCH_LOAD_DWORDX4,"S_SCRATCH_LOAD_DWORDX4"}, // 7
                {amdgpu_gfx90a_op_S_BUFFER_LOAD_DWORD,"S_BUFFER_LOAD_DWORD"}, // 8
                {amdgpu_gfx90a_op_S_BUFFER_LOAD_DWORDX2,"S_BUFFER_LOAD_DWORDX2"}, // 9
                ...
                {amdgpu_gfx90a_op_S_DCACHE_WB_VOL,"S_DCACHE_WB_VOL"}, // 35
                {amdgpu_gfx90a_op_S_MEMTIME,"S_MEMTIME"}, // 36
                {amdgpu_gfx90a_op_S_MEMREALTIME,"S_MEMREALTIME"}, // 37
                {amdgpu_gfx90a_op_S_ATC_PROBE,"S_ATC_PROBE"}, // 38
                ...
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_SUB,"S_BUFFER_ATOMIC_SUB"}, // 67
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_SMIN,"S_BUFFER_ATOMIC_SMIN"}, // 68
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_UMIN,"S_BUFFER_ATOMIC_UMIN"}, // 69
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_SMAX,"S_BUFFER_ATOMIC_SMAX"}, // 70
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_UMAX,"S_BUFFER_ATOMIC_UMAX"}, // 71
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_AND,"S_BUFFER_ATOMIC_AND"}, // 72
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_OR,"S_BUFFER_ATOMIC_OR"}, // 73
                ...
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_SUB_X2,"S_BUFFER_ATOMIC_SUB_X2"}, // 99
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_SMIN_X2,"S_BUFFER_ATOMIC_SMIN_X2"}, // 100
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_UMIN_X2,"S_BUFFER_ATOMIC_UMIN_X2"}, // 101
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_SMAX_X2,"S_BUFFER_ATOMIC_SMAX_X2"}, // 102
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_UMAX_X2,"S_BUFFER_ATOMIC_UMAX_X2"}, // 103
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_AND_X2,"S_BUFFER_ATOMIC_AND_X2"}, // 104
                {amdgpu_gfx90a_op_S_BUFFER_ATOMIC_OR_X2,"S_BUFFER_ATOMIC_OR_X2"}, // 105
                ...
                {amdgpu_gfx90a_op_S_ATOMIC_SUB,"S_ATOMIC_SUB"}, // 131
                {amdgpu_gfx90a_op_S_ATOMIC_SMIN,"S_ATOMIC_SMIN"}, // 132
                {amdgpu_gfx90a_op_S_ATOMIC_UMIN,"S_ATOMIC_UMIN"}, // 133
                {amdgpu_gfx90a_op_S_ATOMIC_SMAX,"S_ATOMIC_SMAX"}, // 134
                {amdgpu_gfx90a_op_S_ATOMIC_UMAX,"S_ATOMIC_UMAX"}, // 135
                {amdgpu_gfx90a_op_S_ATOMIC_AND,"S_ATOMIC_AND"}, // 136
                {amdgpu_gfx90a_op_S_ATOMIC_OR,"S_ATOMIC_OR"}, // 137
                ...
                {amdgpu_gfx90a_op_S_ATOMIC_SUB_X2,"S_ATOMIC_SUB_X2"}, // 163
                {amdgpu_gfx90a_op_S_ATOMIC_SMIN_X2,"S_ATOMIC_SMIN_X2"}, // 164
                {amdgpu_gfx90a_op_S_ATOMIC_UMIN_X2,"S_ATOMIC_UMIN_X2"}, // 165
                {amdgpu_gfx90a_op_S_ATOMIC_SMAX_X2,"S_ATOMIC_SMAX_X2"}, // 166
                {amdgpu_gfx90a_op_S_ATOMIC_UMAX_X2,"S_ATOMIC_UMAX_X2"}, // 167
                {amdgpu_gfx90a_op_S_ATOMIC_AND_X2,"S_ATOMIC_AND_X2"}, // 168
                {amdgpu_gfx90a_op_S_ATOMIC_OR_X2,"S_ATOMIC_OR_X2"}, // 169
                {amdgpu_gfx90a_op_S_ATOMIC_XOR_X2,"S_ATOMIC_XOR_X2"}, // 170
                {amdgpu_gfx90a_op_S_ATOMIC_INC_X2,"S_ATOMIC_INC_X2"}, // 171
                {amdgpu_gfx90a_op_S_ATOMIC_DEC_X2,"S_ATOMIC_DEC_X2"}, // 172
            }; // end ENC_SMEM_insn_table
            const amdgpu_gfx90a_insn_entry ENC_SOP1_insn_table[56] = 
            {
                {amdgpu_gfx90a_op_S_MOV_B32,"S_MOV_B32"}, // 0
                {amdgpu_gfx90a_op_S_MOV_B64,"S_MOV_B64"}, // 1
                {amdgpu_gfx90a_op_S_CMOV_B32,"S_CMOV_B32"}, // 2
                {amdgpu_gfx90a_op_S_CMOV_B64,"S_CMOV_B64"}, // 3
                {amdgpu_gfx90a_op_S_NOT_B32,"S_NOT_B32"}, // 4
                {amdgpu_gfx90a_op_S_NOT_B64,"S_NOT_B64"}, // 5
                {amdgpu_gfx90a_op_S_WQM_B32,"S_WQM_B32"}, // 6
                {amdgpu_gfx90a_op_S_WQM_B64,"S_WQM_B64"}, // 7
                {amdgpu_gfx90a_op_S_BREV_B32,"S_BREV_B32"}, // 8
                {amdgpu_gfx90a_op_S_BREV_B64,"S_BREV_B64"}, // 9
                {amdgpu_gfx90a_op_S_BCNT0_I32_B32,"S_BCNT0_I32_B32"}, // 10
                {amdgpu_gfx90a_op_S_BCNT0_I32_B64,"S_BCNT0_I32_B64"}, // 11
                {amdgpu_gfx90a_op_S_BCNT1_I32_B32,"S_BCNT1_I32_B32"}, // 12
                {amdgpu_gfx90a_op_S_BCNT1_I32_B64,"S_BCNT1_I32_B64"}, // 13
                {amdgpu_gfx90a_op_S_FF0_I32_B32,"S_FF0_I32_B32"}, // 14
                {amdgpu_gfx90a_op_S_FF0_I32_B64,"S_FF0_I32_B64"}, // 15
                {amdgpu_gfx90a_op_S_FF1_I32_B32,"S_FF1_I32_B32"}, // 16
                {amdgpu_gfx90a_op_S_FF1_I32_B64,"S_FF1_I32_B64"}, // 17
                {amdgpu_gfx90a_op_S_FLBIT_I32_B32,"S_FLBIT_I32_B32"}, // 18
                {amdgpu_gfx90a_op_S_FLBIT_I32_B64,"S_FLBIT_I32_B64"}, // 19
                {amdgpu_gfx90a_op_S_FLBIT_I32,"S_FLBIT_I32"}, // 20
                {amdgpu_gfx90a_op_S_FLBIT_I32_I64,"S_FLBIT_I32_I64"}, // 21
                {amdgpu_gfx90a_op_S_SEXT_I32_I8,"S_SEXT_I32_I8"}, // 22
                {amdgpu_gfx90a_op_S_SEXT_I32_I16,"S_SEXT_I32_I16"}, // 23
                {amdgpu_gfx90a_op_S_BITSET0_B32,"S_BITSET0_B32"}, // 24
                ...
                {amdgpu_gfx90a_op_S_GETPC_B64,"S_GETPC_B64"}, // 28
                {amdgpu_gfx90a_op_S_SETPC_B64,"S_SETPC_B64"}, // 29
                {amdgpu_gfx90a_op_S_SWAPPC_B64,"S_SWAPPC_B64"}, // 30
                {amdgpu_gfx90a_op_S_RFE_B64,"S_RFE_B64"}, // 31
                ...
                {amdgpu_gfx90a_op_S_ANDN2_SAVEEXEC_B64,"S_ANDN2_SAVEEXEC_B64"}, // 35
                {amdgpu_gfx90a_op_S_ORN2_SAVEEXEC_B64,"S_ORN2_SAVEEXEC_B64"}, // 36
                {amdgpu_gfx90a_op_S_NAND_SAVEEXEC_B64,"S_NAND_SAVEEXEC_B64"}, // 37
                {amdgpu_gfx90a_op_S_NOR_SAVEEXEC_B64,"S_NOR_SAVEEXEC_B64"}, // 38
                ...
                {amdgpu_gfx90a_op_S_MOVRELS_B32,"S_MOVRELS_B32"}, // 42
                {amdgpu_gfx90a_op_S_MOVRELS_B64,"S_MOVRELS_B64"}, // 43
                ...
                {amdgpu_gfx90a_op_S_ANDN1_WREXEC_B64,"S_ANDN1_WREXEC_B64"}, // 53
                {amdgpu_gfx90a_op_S_ANDN2_WREXEC_B64,"S_ANDN2_WREXEC_B64"}, // 54
                {amdgpu_gfx90a_op_S_BITREPLICATE_B64_B32,"S_BITREPLICATE_B64_B32"}, // 55
            }; // end ENC_SOP1_insn_table
            const amdgpu_gfx90a_insn_entry ENC_SOP2_insn_table[53] = 
            {
                {amdgpu_gfx90a_op_S_ADD_U32,"S_ADD_U32"}, // 0
                {amdgpu_gfx90a_op_S_SUB_U32,"S_SUB_U32"}, // 1
                {amdgpu_gfx90a_op_S_ADD_I32,"S_ADD_I32"}, // 2
                {amdgpu_gfx90a_op_S_SUB_I32,"S_SUB_I32"}, // 3
                {amdgpu_gfx90a_op_S_ADDC_U32,"S_ADDC_U32"}, // 4
                {amdgpu_gfx90a_op_S_SUBB_U32,"S_SUBB_U32"}, // 5
                {amdgpu_gfx90a_op_S_MIN_I32,"S_MIN_I32"}, // 6
                {amdgpu_gfx90a_op_S_MIN_U32,"S_MIN_U32"}, // 7
                {amdgpu_gfx90a_op_S_MAX_I32,"S_MAX_I32"}, // 8
                {amdgpu_gfx90a_op_S_MAX_U32,"S_MAX_U32"}, // 9
                {amdgpu_gfx90a_op_S_CSELECT_B32,"S_CSELECT_B32"}, // 10
                {amdgpu_gfx90a_op_S_CSELECT_B64,"S_CSELECT_B64"}, // 11
                {amdgpu_gfx90a_op_S_AND_B32,"S_AND_B32"}, // 12
                {amdgpu_gfx90a_op_S_AND_B64,"S_AND_B64"}, // 13
                {amdgpu_gfx90a_op_S_OR_B32,"S_OR_B32"}, // 14
                {amdgpu_gfx90a_op_S_OR_B64,"S_OR_B64"}, // 15
                {amdgpu_gfx90a_op_S_XOR_B32,"S_XOR_B32"}, // 16
                {amdgpu_gfx90a_op_S_XOR_B64,"S_XOR_B64"}, // 17
                {amdgpu_gfx90a_op_S_ANDN2_B32,"S_ANDN2_B32"}, // 18
                {amdgpu_gfx90a_op_S_ANDN2_B64,"S_ANDN2_B64"}, // 19
                {amdgpu_gfx90a_op_S_ORN2_B32,"S_ORN2_B32"}, // 20
                {amdgpu_gfx90a_op_S_ORN2_B64,"S_ORN2_B64"}, // 21
                {amdgpu_gfx90a_op_S_NAND_B32,"S_NAND_B32"}, // 22
                {amdgpu_gfx90a_op_S_NAND_B64,"S_NAND_B64"}, // 23
                {amdgpu_gfx90a_op_S_NOR_B32,"S_NOR_B32"}, // 24
                {amdgpu_gfx90a_op_S_NOR_B64,"S_NOR_B64"}, // 25
                {amdgpu_gfx90a_op_S_XNOR_B32,"S_XNOR_B32"}, // 26
                {amdgpu_gfx90a_op_S_XNOR_B64,"S_XNOR_B64"}, // 27
                {amdgpu_gfx90a_op_S_LSHL_B32,"S_LSHL_B32"}, // 28
                {amdgpu_gfx90a_op_S_LSHL_B64,"S_LSHL_B64"}, // 29
                {amdgpu_gfx90a_op_S_LSHR_B32,"S_LSHR_B32"}, // 30
                {amdgpu_gfx90a_op_S_LSHR_B64,"S_LSHR_B64"}, // 31
                {amdgpu_gfx90a_op_S_ASHR_I32,"S_ASHR_I32"}, // 32
                {amdgpu_gfx90a_op_S_ASHR_I64,"S_ASHR_I64"}, // 33
                {amdgpu_gfx90a_op_S_BFM_B32,"S_BFM_B32"}, // 34
                {amdgpu_gfx90a_op_S_BFM_B64,"S_BFM_B64"}, // 35
                {amdgpu_gfx90a_op_S_MUL_I32,"S_MUL_I32"}, // 36
                {amdgpu_gfx90a_op_S_BFE_U32,"S_BFE_U32"}, // 37
                {amdgpu_gfx90a_op_S_BFE_I32,"S_BFE_I32"}, // 38
                {amdgpu_gfx90a_op_S_BFE_U64,"S_BFE_U64"}, // 39
                ...
                {amdgpu_gfx90a_op_S_RFE_RESTORE_B64,"S_RFE_RESTORE_B64"}, // 43
                ...
                {amdgpu_gfx90a_op_S_LSHL2_ADD_U32,"S_LSHL2_ADD_U32"}, // 47
                {amdgpu_gfx90a_op_S_LSHL3_ADD_U32,"S_LSHL3_ADD_U32"}, // 48
                {amdgpu_gfx90a_op_S_LSHL4_ADD_U32,"S_LSHL4_ADD_U32"}, // 49
                {amdgpu_gfx90a_op_S_PACK_LL_B32_B16,"S_PACK_LL_B32_B16"}, // 50
                {amdgpu_gfx90a_op_S_PACK_LH_B32_B16,"S_PACK_LH_B32_B16"}, // 51
                {amdgpu_gfx90a_op_S_PACK_HH_B32_B16,"S_PACK_HH_B32_B16"}, // 52
            }; // end ENC_SOP2_insn_table
            const amdgpu_gfx90a_insn_entry ENC_SOPC_insn_table[20] = 
            {
                {amdgpu_gfx90a_op_S_CMP_EQ_I32,"S_CMP_EQ_I32"}, // 0
                {amdgpu_gfx90a_op_S_CMP_LG_I32,"S_CMP_LG_I32"}, // 1
                {amdgpu_gfx90a_op_S_CMP_GT_I32,"S_CMP_GT_I32"}, // 2
                {amdgpu_gfx90a_op_S_CMP_GE_I32,"S_CMP_GE_I32"}, // 3
                {amdgpu_gfx90a_op_S_CMP_LT_I32,"S_CMP_LT_I32"}, // 4
                {amdgpu_gfx90a_op_S_CMP_LE_I32,"S_CMP_LE_I32"}, // 5
                {amdgpu_gfx90a_op_S_CMP_EQ_U32,"S_CMP_EQ_U32"}, // 6
                {amdgpu_gfx90a_op_S_CMP_LG_U32,"S_CMP_LG_U32"}, // 7
                {amdgpu_gfx90a_op_S_CMP_GT_U32,"S_CMP_GT_U32"}, // 8
                {amdgpu_gfx90a_op_S_CMP_GE_U32,"S_CMP_GE_U32"}, // 9
                {amdgpu_gfx90a_op_S_CMP_LT_U32,"S_CMP_LT_U32"}, // 10
                {amdgpu_gfx90a_op_S_CMP_LE_U32,"S_CMP_LE_U32"}, // 11
                {amdgpu_gfx90a_op_S_BITCMP0_B32,"S_BITCMP0_B32"}, // 12
                {amdgpu_gfx90a_op_S_BITCMP1_B32,"S_BITCMP1_B32"}, // 13
                {amdgpu_gfx90a_op_S_BITCMP0_B64,"S_BITCMP0_B64"}, // 14
                {amdgpu_gfx90a_op_S_BITCMP1_B64,"S_BITCMP1_B64"}, // 15
                {amdgpu_gfx90a_op_S_SETVSKIP,"S_SETVSKIP"}, // 16
                {amdgpu_gfx90a_op_S_SET_GPR_IDX_ON,"S_SET_GPR_IDX_ON"}, // 17
                {amdgpu_gfx90a_op_S_CMP_EQ_U64,"S_CMP_EQ_U64"}, // 18
                {amdgpu_gfx90a_op_S_CMP_LG_U64,"S_CMP_LG_U64"}, // 19
            }; // end ENC_SOPC_insn_table
            const amdgpu_gfx90a_insn_entry ENC_SOPK_insn_table[22] = 
            {
                {amdgpu_gfx90a_op_S_MOVK_I32,"S_MOVK_I32"}, // 0
                {amdgpu_gfx90a_op_S_CMOVK_I32,"S_CMOVK_I32"}, // 1
                {amdgpu_gfx90a_op_S_CMPK_EQ_I32,"S_CMPK_EQ_I32"}, // 2
                {amdgpu_gfx90a_op_S_CMPK_LG_I32,"S_CMPK_LG_I32"}, // 3
                {amdgpu_gfx90a_op_S_CMPK_GT_I32,"S_CMPK_GT_I32"}, // 4
                {amdgpu_gfx90a_op_S_CMPK_GE_I32,"S_CMPK_GE_I32"}, // 5
                {amdgpu_gfx90a_op_S_CMPK_LT_I32,"S_CMPK_LT_I32"}, // 6
                {amdgpu_gfx90a_op_S_CMPK_LE_I32,"S_CMPK_LE_I32"}, // 7
                {amdgpu_gfx90a_op_S_CMPK_EQ_U32,"S_CMPK_EQ_U32"}, // 8
                {amdgpu_gfx90a_op_S_CMPK_LG_U32,"S_CMPK_LG_U32"}, // 9
                {amdgpu_gfx90a_op_S_CMPK_GT_U32,"S_CMPK_GT_U32"}, // 10
                {amdgpu_gfx90a_op_S_CMPK_GE_U32,"S_CMPK_GE_U32"}, // 11
                {amdgpu_gfx90a_op_S_CMPK_LT_U32,"S_CMPK_LT_U32"}, // 12
                {amdgpu_gfx90a_op_S_CMPK_LE_U32,"S_CMPK_LE_U32"}, // 13
                {amdgpu_gfx90a_op_S_ADDK_I32,"S_ADDK_I32"}, // 14
                {amdgpu_gfx90a_op_S_MULK_I32,"S_MULK_I32"}, // 15
            ...
            {
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 0
                {amdgpu_gfx90a_op_S_ENDPGM,"S_ENDPGM"}, // 1
                {amdgpu_gfx90a_op_S_BRANCH,"S_BRANCH"}, // 2
                {amdgpu_gfx90a_op_S_WAKEUP,"S_WAKEUP"}, // 3
                {amdgpu_gfx90a_op_S_CBRANCH_SCC0,"S_CBRANCH_SCC0"}, // 4
                {amdgpu_gfx90a_op_S_CBRANCH_SCC1,"S_CBRANCH_SCC1"}, // 5
                {amdgpu_gfx90a_op_S_CBRANCH_VCCZ,"S_CBRANCH_VCCZ"}, // 6
                {amdgpu_gfx90a_op_S_CBRANCH_VCCNZ,"S_CBRANCH_VCCNZ"}, // 7
                {amdgpu_gfx90a_op_S_CBRANCH_EXECZ,"S_CBRANCH_EXECZ"}, // 8
                {amdgpu_gfx90a_op_S_CBRANCH_EXECNZ,"S_CBRANCH_EXECNZ"}, // 9
                {amdgpu_gfx90a_op_S_BARRIER,"S_BARRIER"}, // 10
                {amdgpu_gfx90a_op_S_SETKILL,"S_SETKILL"}, // 11
                {amdgpu_gfx90a_op_S_WAITCNT,"S_WAITCNT"}, // 12
                {amdgpu_gfx90a_op_S_SETHALT,"S_SETHALT"}, // 13
                {amdgpu_gfx90a_op_S_SLEEP,"S_SLEEP"}, // 14
                {amdgpu_gfx90a_op_S_SETPRIO,"S_SETPRIO"}, // 15
                {amdgpu_gfx90a_op_S_SENDMSG,"S_SENDMSG"}, // 16
                {amdgpu_gfx90a_op_S_SENDMSGHALT,"S_SENDMSGHALT"}, // 17
                {amdgpu_gfx90a_op_S_TRAP,"S_TRAP"}, // 18
                {amdgpu_gfx90a_op_S_ICACHE_INV,"S_ICACHE_INV"}, // 19
                {amdgpu_gfx90a_op_S_INCPERFLEVEL,"S_INCPERFLEVEL"}, // 20
                {amdgpu_gfx90a_op_S_DECPERFLEVEL,"S_DECPERFLEVEL"}, // 21
                {amdgpu_gfx90a_op_S_TTRACEDATA,"S_TTRACEDATA"}, // 22
                {amdgpu_gfx90a_op_S_CBRANCH_CDBGSYS,"S_CBRANCH_CDBGSYS"}, // 23
                {amdgpu_gfx90a_op_S_CBRANCH_CDBGUSER,"S_CBRANCH_CDBGUSER"}, // 24
                {amdgpu_gfx90a_op_S_CBRANCH_CDBGSYS_OR_USER,"S_CBRANCH_CDBGSYS_OR_USER"}, // 25
                {amdgpu_gfx90a_op_S_CBRANCH_CDBGSYS_AND_USER,"S_CBRANCH_CDBGSYS_AND_USER"}, // 26
                {amdgpu_gfx90a_op_S_ENDPGM_SAVED,"S_ENDPGM_SAVED"}, // 27
                {amdgpu_gfx90a_op_S_SET_GPR_IDX_OFF,"S_SET_GPR_IDX_OFF"}, // 28
                {amdgpu_gfx90a_op_S_SET_GPR_IDX_MODE,"S_SET_GPR_IDX_MODE"}, // 29
                {amdgpu_gfx90a_op_S_ENDPGM_ORDERED_PS_DONE,"S_ENDPGM_ORDERED_PS_DONE"}, // 30
            }; // end ENC_SOPP_insn_table
            const amdgpu_gfx90a_insn_entry ENC_VOP1_insn_table[83] = 
            {
                {amdgpu_gfx90a_op_V_NOP,"V_NOP"}, // 0
                {amdgpu_gfx90a_op_V_MOV_B32,"V_MOV_B32"}, // 1
                {amdgpu_gfx90a_op_V_READFIRSTLANE_B32,"V_READFIRSTLANE_B32"}, // 2
                ...
                {amdgpu_gfx90a_op_V_CVT_F64_F32,"V_CVT_F64_F32"}, // 16
                ...
                {amdgpu_gfx90a_op_V_CVT_U32_F64,"V_CVT_U32_F64"}, // 21
                ...
                {amdgpu_gfx90a_op_V_RNDNE_F64,"V_RNDNE_F64"}, // 25
                ...
                {amdgpu_gfx90a_op_V_RNDNE_F32,"V_RNDNE_F32"}, // 30
                {amdgpu_gfx90a_op_V_FLOOR_F32,"V_FLOOR_F32"}, // 31
                {amdgpu_gfx90a_op_V_EXP_F32,"V_EXP_F32"}, // 32
                {amdgpu_gfx90a_op_V_LOG_F32,"V_LOG_F32"}, // 33
                ...
                {amdgpu_gfx90a_op_V_RCP_F64,"V_RCP_F64"}, // 37
                {amdgpu_gfx90a_op_V_RSQ_F64,"V_RSQ_F64"}, // 38
                {amdgpu_gfx90a_op_V_SQRT_F32,"V_SQRT_F32"}, // 39
                {amdgpu_gfx90a_op_V_SQRT_F64,"V_SQRT_F64"}, // 40
                {amdgpu_gfx90a_op_V_SIN_F32,"V_SIN_F32"}, // 41
                {amdgpu_gfx90a_op_V_COS_F32,"V_COS_F32"}, // 42
                {amdgpu_gfx90a_op_V_NOT_B32,"V_NOT_B32"}, // 43
                {amdgpu_gfx90a_op_V_BFREV_B32,"V_BFREV_B32"}, // 44
                ...
                {amdgpu_gfx90a_op_V_FREXP_EXP_I32_F64,"V_FREXP_EXP_I32_F64"}, // 48
                {amdgpu_gfx90a_op_V_FREXP_MANT_F64,"V_FREXP_MANT_F64"}, // 49
                ...
                {amdgpu_gfx90a_op_V_CVT_I16_F16,"V_CVT_I16_F16"}, // 60
                {amdgpu_gfx90a_op_V_RCP_F16,"V_RCP_F16"}, // 61
                {amdgpu_gfx90a_op_V_SQRT_F16,"V_SQRT_F16"}, // 62
                {amdgpu_gfx90a_op_V_RSQ_F16,"V_RSQ_F16"}, // 63
                {amdgpu_gfx90a_op_V_LOG_F16,"V_LOG_F16"}, // 64
                {amdgpu_gfx90a_op_V_EXP_F16,"V_EXP_F16"}, // 65
                {amdgpu_gfx90a_op_V_FREXP_MANT_F16,"V_FREXP_MANT_F16"}, // 66
                {amdgpu_gfx90a_op_V_FREXP_EXP_I16_F16,"V_FREXP_EXP_I16_F16"}, // 67
                {amdgpu_gfx90a_op_V_FLOOR_F16,"V_FLOOR_F16"}, // 68
                {amdgpu_gfx90a_op_V_CEIL_F16,"V_CEIL_F16"}, // 69
                {amdgpu_gfx90a_op_V_TRUNC_F16,"V_TRUNC_F16"}, // 70
                {amdgpu_gfx90a_op_V_RNDNE_F16,"V_RNDNE_F16"}, // 71
            ...
            const amdgpu_gfx90a_insn_entry ENC_VOP3_insn_table[674] = 
            {
                ...
                {amdgpu_gfx90a_op_V_CMP_LE_F16,"V_CMP_LE_F16"}, // 35
                {amdgpu_gfx90a_op_V_CMP_GT_F16,"V_CMP_GT_F16"}, // 36
                {amdgpu_gfx90a_op_V_CMP_LG_F16,"V_CMP_LG_F16"}, // 37
                {amdgpu_gfx90a_op_V_CMP_GE_F16,"V_CMP_GE_F16"}, // 38
                {amdgpu_gfx90a_op_V_CMP_O_F16,"V_CMP_O_F16"}, // 39
                {amdgpu_gfx90a_op_V_CMP_U_F16,"V_CMP_U_F16"}, // 40
                {amdgpu_gfx90a_op_V_CMP_NGE_F16,"V_CMP_NGE_F16"}, // 41
                {amdgpu_gfx90a_op_V_CMP_NLG_F16,"V_CMP_NLG_F16"}, // 42
                {amdgpu_gfx90a_op_V_CMP_NGT_F16,"V_CMP_NGT_F16"}, // 43
                {amdgpu_gfx90a_op_V_CMP_NLE_F16,"V_CMP_NLE_F16"}, // 44
                {amdgpu_gfx90a_op_V_CMP_NEQ_F16,"V_CMP_NEQ_F16"}, // 45
                {amdgpu_gfx90a_op_V_CMP_NLT_F16,"V_CMP_NLT_F16"}, // 46
                {amdgpu_gfx90a_op_V_CMP_TRU_F16,"V_CMP_TRU_F16"}, // 47
                {amdgpu_gfx90a_op_V_CMPX_F_F16,"V_CMPX_F_F16"}, // 48
                {amdgpu_gfx90a_op_V_CMPX_LT_F16,"V_CMPX_LT_F16"}, // 49
                {amdgpu_gfx90a_op_V_CMPX_EQ_F16,"V_CMPX_EQ_F16"}, // 50
                {amdgpu_gfx90a_op_V_CMPX_LE_F16,"V_CMPX_LE_F16"}, // 51
                {amdgpu_gfx90a_op_V_CMPX_GT_F16,"V_CMPX_GT_F16"}, // 52
                {amdgpu_gfx90a_op_V_CMPX_LG_F16,"V_CMPX_LG_F16"}, // 53
                {amdgpu_gfx90a_op_V_CMPX_GE_F16,"V_CMPX_GE_F16"}, // 54
                {amdgpu_gfx90a_op_V_CMPX_O_F16,"V_CMPX_O_F16"}, // 55
                {amdgpu_gfx90a_op_V_CMPX_U_F16,"V_CMPX_U_F16"}, // 56
                {amdgpu_gfx90a_op_V_CMPX_NGE_F16,"V_CMPX_NGE_F16"}, // 57
                {amdgpu_gfx90a_op_V_CMPX_NLG_F16,"V_CMPX_NLG_F16"}, // 58
                {amdgpu_gfx90a_op_V_CMPX_NGT_F16,"V_CMPX_NGT_F16"}, // 59
                {amdgpu_gfx90a_op_V_CMPX_NLE_F16,"V_CMPX_NLE_F16"}, // 60
                {amdgpu_gfx90a_op_V_CMPX_NEQ_F16,"V_CMPX_NEQ_F16"}, // 61
                {amdgpu_gfx90a_op_V_CMPX_NLT_F16,"V_CMPX_NLT_F16"}, // 62
                {amdgpu_gfx90a_op_V_CMPX_TRU_F16,"V_CMPX_TRU_F16"}, // 63
                {amdgpu_gfx90a_op_V_CMP_F_F32,"V_CMP_F_F32"}, // 64
                {amdgpu_gfx90a_op_V_CMP_LT_F32,"V_CMP_LT_F32"}, // 65
                {amdgpu_gfx90a_op_V_CMP_EQ_F32,"V_CMP_EQ_F32"}, // 66
                {amdgpu_gfx90a_op_V_CMP_LE_F32,"V_CMP_LE_F32"}, // 67
                {amdgpu_gfx90a_op_V_CMP_GT_F32,"V_CMP_GT_F32"}, // 68
                {amdgpu_gfx90a_op_V_CMP_LG_F32,"V_CMP_LG_F32"}, // 69
                {amdgpu_gfx90a_op_V_CMP_GE_F32,"V_CMP_GE_F32"}, // 70
                {amdgpu_gfx90a_op_V_CMP_O_F32,"V_CMP_O_F32"}, // 71
                {amdgpu_gfx90a_op_V_CMP_U_F32,"V_CMP_U_F32"}, // 72
                {amdgpu_gfx90a_op_V_CMP_NGE_F32,"V_CMP_NGE_F32"}, // 73
                {amdgpu_gfx90a_op_V_CMP_NLG_F32,"V_CMP_NLG_F32"}, // 74
                {amdgpu_gfx90a_op_V_CMP_NGT_F32,"V_CMP_NGT_F32"}, // 75
                {amdgpu_gfx90a_op_V_CMP_NLE_F32,"V_CMP_NLE_F32"}, // 76
                {amdgpu_gfx90a_op_V_CMP_NEQ_F32,"V_CMP_NEQ_F32"}, // 77
                {amdgpu_gfx90a_op_V_CMP_NLT_F32,"V_CMP_NLT_F32"}, // 78
                {amdgpu_gfx90a_op_V_CMP_TRU_F32,"V_CMP_TRU_F32"}, // 79
                {amdgpu_gfx90a_op_V_CMPX_F_F32,"V_CMPX_F_F32"}, // 80
                {amdgpu_gfx90a_op_V_CMPX_LT_F32,"V_CMPX_LT_F32"}, // 81
                {amdgpu_gfx90a_op_V_CMPX_EQ_F32,"V_CMPX_EQ_F32"}, // 82
                {amdgpu_gfx90a_op_V_CMPX_LE_F32,"V_CMPX_LE_F32"}, // 83
                {amdgpu_gfx90a_op_V_CMPX_GT_F32,"V_CMPX_GT_F32"}, // 84
                {amdgpu_gfx90a_op_V_CMPX_LG_F32,"V_CMPX_LG_F32"}, // 85
                {amdgpu_gfx90a_op_V_CMPX_GE_F32,"V_CMPX_GE_F32"}, // 86
                {amdgpu_gfx90a_op_V_CMPX_O_F32,"V_CMPX_O_F32"}, // 87
                {amdgpu_gfx90a_op_V_CMPX_U_F32,"V_CMPX_U_F32"}, // 88
                {amdgpu_gfx90a_op_V_CMPX_NGE_F32,"V_CMPX_NGE_F32"}, // 89
                {amdgpu_gfx90a_op_V_CMPX_NLG_F32,"V_CMPX_NLG_F32"}, // 90
                {amdgpu_gfx90a_op_V_CMPX_NGT_F32,"V_CMPX_NGT_F32"}, // 91
                {amdgpu_gfx90a_op_V_CMPX_NLE_F32,"V_CMPX_NLE_F32"}, // 92
                ...
                {amdgpu_gfx90a_op_V_CMP_F_F64,"V_CMP_F_F64"}, // 96
                {amdgpu_gfx90a_op_V_CMP_LT_F64,"V_CMP_LT_F64"}, // 97
                {amdgpu_gfx90a_op_V_CMP_EQ_F64,"V_CMP_EQ_F64"}, // 98
                {amdgpu_gfx90a_op_V_CMP_LE_F64,"V_CMP_LE_F64"}, // 99
                {amdgpu_gfx90a_op_V_CMP_GT_F64,"V_CMP_GT_F64"}, // 100
                {amdgpu_gfx90a_op_V_CMP_LG_F64,"V_CMP_LG_F64"}, // 101
                {amdgpu_gfx90a_op_V_CMP_GE_F64,"V_CMP_GE_F64"}, // 102
                {amdgpu_gfx90a_op_V_CMP_O_F64,"V_CMP_O_F64"}, // 103
                {amdgpu_gfx90a_op_V_CMP_U_F64,"V_CMP_U_F64"}, // 104
                {amdgpu_gfx90a_op_V_CMP_NGE_F64,"V_CMP_NGE_F64"}, // 105
                {amdgpu_gfx90a_op_V_CMP_NLG_F64,"V_CMP_NLG_F64"}, // 106
                {amdgpu_gfx90a_op_V_CMP_NGT_F64,"V_CMP_NGT_F64"}, // 107
                {amdgpu_gfx90a_op_V_CMP_NLE_F64,"V_CMP_NLE_F64"}, // 108
                {amdgpu_gfx90a_op_V_CMP_NEQ_F64,"V_CMP_NEQ_F64"}, // 109
                {amdgpu_gfx90a_op_V_CMP_NLT_F64,"V_CMP_NLT_F64"}, // 110
                {amdgpu_gfx90a_op_V_CMP_TRU_F64,"V_CMP_TRU_F64"}, // 111
                {amdgpu_gfx90a_op_V_CMPX_F_F64,"V_CMPX_F_F64"}, // 112
                {amdgpu_gfx90a_op_V_CMPX_LT_F64,"V_CMPX_LT_F64"}, // 113
                {amdgpu_gfx90a_op_V_CMPX_EQ_F64,"V_CMPX_EQ_F64"}, // 114
                {amdgpu_gfx90a_op_V_CMPX_LE_F64,"V_CMPX_LE_F64"}, // 115
                {amdgpu_gfx90a_op_V_CMPX_GT_F64,"V_CMPX_GT_F64"}, // 116
                {amdgpu_gfx90a_op_V_CMPX_LG_F64,"V_CMPX_LG_F64"}, // 117
                {amdgpu_gfx90a_op_V_CMPX_GE_F64,"V_CMPX_GE_F64"}, // 118
                {amdgpu_gfx90a_op_V_CMPX_O_F64,"V_CMPX_O_F64"}, // 119
                {amdgpu_gfx90a_op_V_CMPX_U_F64,"V_CMPX_U_F64"}, // 120
                {amdgpu_gfx90a_op_V_CMPX_NGE_F64,"V_CMPX_NGE_F64"}, // 121
                {amdgpu_gfx90a_op_V_CMPX_NLG_F64,"V_CMPX_NLG_F64"}, // 122
                {amdgpu_gfx90a_op_V_CMPX_NGT_F64,"V_CMPX_NGT_F64"}, // 123
                {amdgpu_gfx90a_op_V_CMPX_NLE_F64,"V_CMPX_NLE_F64"}, // 124
                ...
                {amdgpu_gfx90a_op_V_CMP_LE_I16,"V_CMP_LE_I16"}, // 163
                {amdgpu_gfx90a_op_V_CMP_GT_I16,"V_CMP_GT_I16"}, // 164
                {amdgpu_gfx90a_op_V_CMP_NE_I16,"V_CMP_NE_I16"}, // 165
                {amdgpu_gfx90a_op_V_CMP_GE_I16,"V_CMP_GE_I16"}, // 166
                {amdgpu_gfx90a_op_V_CMP_T_I16,"V_CMP_T_I16"}, // 167
                {amdgpu_gfx90a_op_V_CMP_F_U16,"V_CMP_F_U16"}, // 168
                {amdgpu_gfx90a_op_V_CMP_LT_U16,"V_CMP_LT_U16"}, // 169
                {amdgpu_gfx90a_op_V_CMP_EQ_U16,"V_CMP_EQ_U16"}, // 170
                {amdgpu_gfx90a_op_V_CMP_LE_U16,"V_CMP_LE_U16"}, // 171
                {amdgpu_gfx90a_op_V_CMP_GT_U16,"V_CMP_GT_U16"}, // 172
                {amdgpu_gfx90a_op_V_CMP_NE_U16,"V_CMP_NE_U16"}, // 173
                {amdgpu_gfx90a_op_V_CMP_GE_U16,"V_CMP_GE_U16"}, // 174
                {amdgpu_gfx90a_op_V_CMP_T_U16,"V_CMP_T_U16"}, // 175
                {amdgpu_gfx90a_op_V_CMPX_F_I16,"V_CMPX_F_I16"}, // 176
                {amdgpu_gfx90a_op_V_CMPX_LT_I16,"V_CMPX_LT_I16"}, // 177
                {amdgpu_gfx90a_op_V_CMPX_EQ_I16,"V_CMPX_EQ_I16"}, // 178
                {amdgpu_gfx90a_op_V_CMPX_LE_I16,"V_CMPX_LE_I16"}, // 179
                {amdgpu_gfx90a_op_V_CMPX_GT_I16,"V_CMPX_GT_I16"}, // 180
                {amdgpu_gfx90a_op_V_CMPX_NE_I16,"V_CMPX_NE_I16"}, // 181
                {amdgpu_gfx90a_op_V_CMPX_GE_I16,"V_CMPX_GE_I16"}, // 182
                {amdgpu_gfx90a_op_V_CMPX_T_I16,"V_CMPX_T_I16"}, // 183
                {amdgpu_gfx90a_op_V_CMPX_F_U16,"V_CMPX_F_U16"}, // 184
                {amdgpu_gfx90a_op_V_CMPX_LT_U16,"V_CMPX_LT_U16"}, // 185
                {amdgpu_gfx90a_op_V_CMPX_EQ_U16,"V_CMPX_EQ_U16"}, // 186
                {amdgpu_gfx90a_op_V_CMPX_LE_U16,"V_CMPX_LE_U16"}, // 187
                {amdgpu_gfx90a_op_V_CMPX_GT_U16,"V_CMPX_GT_U16"}, // 188
                {amdgpu_gfx90a_op_V_CMPX_NE_U16,"V_CMPX_NE_U16"}, // 189
                {amdgpu_gfx90a_op_V_CMPX_GE_U16,"V_CMPX_GE_U16"}, // 190
                {amdgpu_gfx90a_op_V_CMPX_T_U16,"V_CMPX_T_U16"}, // 191
                {amdgpu_gfx90a_op_V_CMP_F_I32,"V_CMP_F_I32"}, // 192
                {amdgpu_gfx90a_op_V_CMP_LT_I32,"V_CMP_LT_I32"}, // 193
                {amdgpu_gfx90a_op_V_CMP_EQ_I32,"V_CMP_EQ_I32"}, // 194
                {amdgpu_gfx90a_op_V_CMP_LE_I32,"V_CMP_LE_I32"}, // 195
                {amdgpu_gfx90a_op_V_CMP_GT_I32,"V_CMP_GT_I32"}, // 196
                {amdgpu_gfx90a_op_V_CMP_NE_I32,"V_CMP_NE_I32"}, // 197
                {amdgpu_gfx90a_op_V_CMP_GE_I32,"V_CMP_GE_I32"}, // 198
                {amdgpu_gfx90a_op_V_CMP_T_I32,"V_CMP_T_I32"}, // 199
                {amdgpu_gfx90a_op_V_CMP_F_U32,"V_CMP_F_U32"}, // 200
                {amdgpu_gfx90a_op_V_CMP_LT_U32,"V_CMP_LT_U32"}, // 201
                {amdgpu_gfx90a_op_V_CMP_EQ_U32,"V_CMP_EQ_U32"}, // 202
                {amdgpu_gfx90a_op_V_CMP_LE_U32,"V_CMP_LE_U32"}, // 203
                {amdgpu_gfx90a_op_V_CMP_GT_U32,"V_CMP_GT_U32"}, // 204
                {amdgpu_gfx90a_op_V_CMP_NE_U32,"V_CMP_NE_U32"}, // 205
                {amdgpu_gfx90a_op_V_CMP_GE_U32,"V_CMP_GE_U32"}, // 206
                {amdgpu_gfx90a_op_V_CMP_T_U32,"V_CMP_T_U32"}, // 207
                {amdgpu_gfx90a_op_V_CMPX_F_I32,"V_CMPX_F_I32"}, // 208
                {amdgpu_gfx90a_op_V_CMPX_LT_I32,"V_CMPX_LT_I32"}, // 209
                {amdgpu_gfx90a_op_V_CMPX_EQ_I32,"V_CMPX_EQ_I32"}, // 210
                {amdgpu_gfx90a_op_V_CMPX_LE_I32,"V_CMPX_LE_I32"}, // 211
                {amdgpu_gfx90a_op_V_CMPX_GT_I32,"V_CMPX_GT_I32"}, // 212
                {amdgpu_gfx90a_op_V_CMPX_NE_I32,"V_CMPX_NE_I32"}, // 213
                {amdgpu_gfx90a_op_V_CMPX_GE_I32,"V_CMPX_GE_I32"}, // 214
                {amdgpu_gfx90a_op_V_CMPX_T_I32,"V_CMPX_T_I32"}, // 215
                {amdgpu_gfx90a_op_V_CMPX_F_U32,"V_CMPX_F_U32"}, // 216
                {amdgpu_gfx90a_op_V_CMPX_LT_U32,"V_CMPX_LT_U32"}, // 217
                {amdgpu_gfx90a_op_V_CMPX_EQ_U32,"V_CMPX_EQ_U32"}, // 218
                {amdgpu_gfx90a_op_V_CMPX_LE_U32,"V_CMPX_LE_U32"}, // 219
                {amdgpu_gfx90a_op_V_CMPX_GT_U32,"V_CMPX_GT_U32"}, // 220
                {amdgpu_gfx90a_op_V_CMPX_NE_U32,"V_CMPX_NE_U32"}, // 221
                {amdgpu_gfx90a_op_V_CMPX_GE_U32,"V_CMPX_GE_U32"}, // 222
                {amdgpu_gfx90a_op_V_CMPX_T_U32,"V_CMPX_T_U32"}, // 223
                {amdgpu_gfx90a_op_V_CMP_F_I64,"V_CMP_F_I64"}, // 224
                {amdgpu_gfx90a_op_V_CMP_LT_I64,"V_CMP_LT_I64"}, // 225
                {amdgpu_gfx90a_op_V_CMP_EQ_I64,"V_CMP_EQ_I64"}, // 226
                {amdgpu_gfx90a_op_V_CMP_LE_I64,"V_CMP_LE_I64"}, // 227
                {amdgpu_gfx90a_op_V_CMP_GT_I64,"V_CMP_GT_I64"}, // 228
                {amdgpu_gfx90a_op_V_CMP_NE_I64,"V_CMP_NE_I64"}, // 229
                {amdgpu_gfx90a_op_V_CMP_GE_I64,"V_CMP_GE_I64"}, // 230
                {amdgpu_gfx90a_op_V_CMP_T_I64,"V_CMP_T_I64"}, // 231
                {amdgpu_gfx90a_op_V_CMP_F_U64,"V_CMP_F_U64"}, // 232
                {amdgpu_gfx90a_op_V_CMP_LT_U64,"V_CMP_LT_U64"}, // 233
                {amdgpu_gfx90a_op_V_CMP_EQ_U64,"V_CMP_EQ_U64"}, // 234
                {amdgpu_gfx90a_op_V_CMP_LE_U64,"V_CMP_LE_U64"}, // 235
                {amdgpu_gfx90a_op_V_CMP_GT_U64,"V_CMP_GT_U64"}, // 236
                {amdgpu_gfx90a_op_V_CMP_NE_U64,"V_CMP_NE_U64"}, // 237
                {amdgpu_gfx90a_op_V_CMP_GE_U64,"V_CMP_GE_U64"}, // 238
                {amdgpu_gfx90a_op_V_CMP_T_U64,"V_CMP_T_U64"}, // 239
                {amdgpu_gfx90a_op_V_CMPX_F_I64,"V_CMPX_F_I64"}, // 240
                {amdgpu_gfx90a_op_V_CMPX_LT_I64,"V_CMPX_LT_I64"}, // 241
                {amdgpu_gfx90a_op_V_CMPX_EQ_I64,"V_CMPX_EQ_I64"}, // 242
                {amdgpu_gfx90a_op_V_CMPX_LE_I64,"V_CMPX_LE_I64"}, // 243
                {amdgpu_gfx90a_op_V_CMPX_GT_I64,"V_CMPX_GT_I64"}, // 244
                {amdgpu_gfx90a_op_V_CMPX_NE_I64,"V_CMPX_NE_I64"}, // 245
                {amdgpu_gfx90a_op_V_CMPX_GE_I64,"V_CMPX_GE_I64"}, // 246
                {amdgpu_gfx90a_op_V_CMPX_T_I64,"V_CMPX_T_I64"}, // 247
                {amdgpu_gfx90a_op_V_CMPX_F_U64,"V_CMPX_F_U64"}, // 248
                {amdgpu_gfx90a_op_V_CMPX_LT_U64,"V_CMPX_LT_U64"}, // 249
                {amdgpu_gfx90a_op_V_CMPX_EQ_U64,"V_CMPX_EQ_U64"}, // 250
                {amdgpu_gfx90a_op_V_CMPX_LE_U64,"V_CMPX_LE_U64"}, // 251
                {amdgpu_gfx90a_op_V_CMPX_GT_U64,"V_CMPX_GT_U64"}, // 252
                {amdgpu_gfx90a_op_V_CMPX_NE_U64,"V_CMPX_NE_U64"}, // 253
                {amdgpu_gfx90a_op_V_CMPX_GE_U64,"V_CMPX_GE_U64"}, // 254
                {amdgpu_gfx90a_op_V_CMPX_T_U64,"V_CMPX_T_U64"}, // 255
                {amdgpu_gfx90a_op_V_CNDMASK_B32,"V_CNDMASK_B32"}, // 256
                {amdgpu_gfx90a_op_V_ADD_F32,"V_ADD_F32"}, // 257
                {amdgpu_gfx90a_op_V_SUB_F32,"V_SUB_F32"}, // 258
                {amdgpu_gfx90a_op_V_SUBREV_F32,"V_SUBREV_F32"}, // 259
                {amdgpu_gfx90a_op_V_FMAC_F64,"V_FMAC_F64"}, // 260
                {amdgpu_gfx90a_op_V_MUL_F32,"V_MUL_F32"}, // 261
                {amdgpu_gfx90a_op_V_MUL_I32_I24,"V_MUL_I32_I24"}, // 262
                {amdgpu_gfx90a_op_V_MUL_HI_I32_I24,"V_MUL_HI_I32_I24"}, // 263
                {amdgpu_gfx90a_op_V_MUL_U32_U24,"V_MUL_U32_U24"}, // 264
                {amdgpu_gfx90a_op_V_MUL_HI_U32_U24,"V_MUL_HI_U32_U24"}, // 265
                {amdgpu_gfx90a_op_V_MIN_F32,"V_MIN_F32"}, // 266
                {amdgpu_gfx90a_op_V_MAX_F32,"V_MAX_F32"}, // 267
                {amdgpu_gfx90a_op_V_MIN_I32,"V_MIN_I32"}, // 268
                {amdgpu_gfx90a_op_V_MAX_I32,"V_MAX_I32"}, // 269
                {amdgpu_gfx90a_op_V_MIN_U32,"V_MIN_U32"}, // 270
                {amdgpu_gfx90a_op_V_MAX_U32,"V_MAX_U32"}, // 271
                {amdgpu_gfx90a_op_V_LSHRREV_B32,"V_LSHRREV_B32"}, // 272
                {amdgpu_gfx90a_op_V_ASHRREV_I32,"V_ASHRREV_I32"}, // 273
                {amdgpu_gfx90a_op_V_LSHLREV_B32,"V_LSHLREV_B32"}, // 274
                {amdgpu_gfx90a_op_V_AND_B32,"V_AND_B32"}, // 275
                ...
                {amdgpu_gfx90a_op_V_MUL_LO_U16,"V_MUL_LO_U16"}, // 297
                {amdgpu_gfx90a_op_V_LSHLREV_B16,"V_LSHLREV_B16"}, // 298
                {amdgpu_gfx90a_op_V_LSHRREV_B16,"V_LSHRREV_B16"}, // 299
                {amdgpu_gfx90a_op_V_ASHRREV_I16,"V_ASHRREV_I16"}, // 300
                {amdgpu_gfx90a_op_V_MAX_F16,"V_MAX_F16"}, // 301
                {amdgpu_gfx90a_op_V_MIN_F16,"V_MIN_F16"}, // 302
                {amdgpu_gfx90a_op_V_MAX_U16,"V_MAX_U16"}, // 303
                {amdgpu_gfx90a_op_V_MAX_I16,"V_MAX_I16"}, // 304
                {amdgpu_gfx90a_op_V_MIN_U16,"V_MIN_U16"}, // 305
                {amdgpu_gfx90a_op_V_MIN_I16,"V_MIN_I16"}, // 306
                {amdgpu_gfx90a_op_V_LDEXP_F16,"V_LDEXP_F16"}, // 307
                {amdgpu_gfx90a_op_V_ADD_U32,"V_ADD_U32"}, // 308
                {amdgpu_gfx90a_op_V_SUB_U32,"V_SUB_U32"}, // 309
                {amdgpu_gfx90a_op_V_SUBREV_U32,"V_SUBREV_U32"}, // 310
                {amdgpu_gfx90a_op_V_DOT2C_F32_F16,"V_DOT2C_F32_F16"}, // 311
                {amdgpu_gfx90a_op_V_DOT2C_I32_I16,"V_DOT2C_I32_I16"}, // 312
                {amdgpu_gfx90a_op_V_DOT4C_I32_I8,"V_DOT4C_I32_I8"}, // 313
                {amdgpu_gfx90a_op_V_DOT8C_I32_I4,"V_DOT8C_I32_I4"}, // 314
                ...
                {amdgpu_gfx90a_op_V_CVT_I32_F64,"V_CVT_I32_F64"}, // 323
                {amdgpu_gfx90a_op_V_CVT_F64_I32,"V_CVT_F64_I32"}, // 324
                {amdgpu_gfx90a_op_V_CVT_F32_I32,"V_CVT_F32_I32"}, // 325
                ...
                {amdgpu_gfx90a_op_V_CVT_FLR_I32_F32,"V_CVT_FLR_I32_F32"}, // 333
                {amdgpu_gfx90a_op_V_CVT_OFF_F32_I4,"V_CVT_OFF_F32_I4"}, // 334
                {amdgpu_gfx90a_op_V_CVT_F32_F64,"V_CVT_F32_F64"}, // 335
                {amdgpu_gfx90a_op_V_CVT_F64_F32,"V_CVT_F64_F32"}, // 336
                {amdgpu_gfx90a_op_V_CVT_F32_UBYTE0,"V_CVT_F32_UBYTE0"}, // 337
                {amdgpu_gfx90a_op_V_CVT_F32_UBYTE1,"V_CVT_F32_UBYTE1"}, // 338
                {amdgpu_gfx90a_op_V_CVT_F32_UBYTE2,"V_CVT_F32_UBYTE2"}, // 339
                {amdgpu_gfx90a_op_V_CVT_F32_UBYTE3,"V_CVT_F32_UBYTE3"}, // 340
                {amdgpu_gfx90a_op_V_CVT_U32_F64,"V_CVT_U32_F64"}, // 341
                {amdgpu_gfx90a_op_V_CVT_F64_U32,"V_CVT_F64_U32"}, // 342
                {amdgpu_gfx90a_op_V_TRUNC_F64,"V_TRUNC_F64"}, // 343
                {amdgpu_gfx90a_op_V_CEIL_F64,"V_CEIL_F64"}, // 344
                {amdgpu_gfx90a_op_V_RNDNE_F64,"V_RNDNE_F64"}, // 345
                {amdgpu_gfx90a_op_V_FLOOR_F64,"V_FLOOR_F64"}, // 346
                {amdgpu_gfx90a_op_V_FRACT_F32,"V_FRACT_F32"}, // 347
                {amdgpu_gfx90a_op_V_TRUNC_F32,"V_TRUNC_F32"}, // 348
                {amdgpu_gfx90a_op_V_CEIL_F32,"V_CEIL_F32"}, // 349
                {amdgpu_gfx90a_op_V_RNDNE_F32,"V_RNDNE_F32"}, // 350
                {amdgpu_gfx90a_op_V_FLOOR_F32,"V_FLOOR_F32"}, // 351
                {amdgpu_gfx90a_op_V_EXP_F32,"V_EXP_F32"}, // 352
                {amdgpu_gfx90a_op_V_LOG_F32,"V_LOG_F32"}, // 353
                {amdgpu_gfx90a_op_V_RCP_F32,"V_RCP_F32"}, // 354
                {amdgpu_gfx90a_op_V_RCP_IFLAG_F32,"V_RCP_IFLAG_F32"}, // 355
                {amdgpu_gfx90a_op_V_RSQ_F32,"V_RSQ_F32"}, // 356
                {amdgpu_gfx90a_op_V_RCP_F64,"V_RCP_F64"}, // 357
                {amdgpu_gfx90a_op_V_RSQ_F64,"V_RSQ_F64"}, // 358
                {amdgpu_gfx90a_op_V_SQRT_F32,"V_SQRT_F32"}, // 359
                {amdgpu_gfx90a_op_V_SQRT_F64,"V_SQRT_F64"}, // 360
                {amdgpu_gfx90a_op_V_SIN_F32,"V_SIN_F32"}, // 361
                {amdgpu_gfx90a_op_V_COS_F32,"V_COS_F32"}, // 362
                {amdgpu_gfx90a_op_V_NOT_B32,"V_NOT_B32"}, // 363
                {amdgpu_gfx90a_op_V_BFREV_B32,"V_BFREV_B32"}, // 364
                {amdgpu_gfx90a_op_V_FFBH_U32,"V_FFBH_U32"}, // 365
                {amdgpu_gfx90a_op_V_FFBL_B32,"V_FFBL_B32"}, // 366
                {amdgpu_gfx90a_op_V_FFBH_I32,"V_FFBH_I32"}, // 367
                {amdgpu_gfx90a_op_V_FREXP_EXP_I32_F64,"V_FREXP_EXP_I32_F64"}, // 368
                {amdgpu_gfx90a_op_V_FREXP_MANT_F64,"V_FREXP_MANT_F64"}, // 369
                {amdgpu_gfx90a_op_V_FRACT_F64,"V_FRACT_F64"}, // 370
                ...
                {amdgpu_gfx90a_op_V_CVT_I16_F16,"V_CVT_I16_F16"}, // 380
                {amdgpu_gfx90a_op_V_RCP_F16,"V_RCP_F16"}, // 381
                {amdgpu_gfx90a_op_V_SQRT_F16,"V_SQRT_F16"}, // 382
                {amdgpu_gfx90a_op_V_RSQ_F16,"V_RSQ_F16"}, // 383
                {amdgpu_gfx90a_op_V_LOG_F16,"V_LOG_F16"}, // 384
                {amdgpu_gfx90a_op_V_EXP_F16,"V_EXP_F16"}, // 385
                {amdgpu_gfx90a_op_V_FREXP_MANT_F16,"V_FREXP_MANT_F16"}, // 386
                {amdgpu_gfx90a_op_V_FREXP_EXP_I16_F16,"V_FREXP_EXP_I16_F16"}, // 387
                {amdgpu_gfx90a_op_V_FLOOR_F16,"V_FLOOR_F16"}, // 388
                {amdgpu_gfx90a_op_V_CEIL_F16,"V_CEIL_F16"}, // 389
                {amdgpu_gfx90a_op_V_TRUNC_F16,"V_TRUNC_F16"}, // 390
                {amdgpu_gfx90a_op_V_RNDNE_F16,"V_RNDNE_F16"}, // 391
                ...
                {amdgpu_gfx90a_op_V_MAD_U32_U24,"V_MAD_U32_U24"}, // 451
                {amdgpu_gfx90a_op_V_CUBEID_F32,"V_CUBEID_F32"}, // 452
                {amdgpu_gfx90a_op_V_CUBESC_F32,"V_CUBESC_F32"}, // 453
                {amdgpu_gfx90a_op_V_CUBETC_F32,"V_CUBETC_F32"}, // 454
                {amdgpu_gfx90a_op_V_CUBEMA_F32,"V_CUBEMA_F32"}, // 455
                {amdgpu_gfx90a_op_V_BFE_U32,"V_BFE_U32"}, // 456
                {amdgpu_gfx90a_op_V_BFE_I32,"V_BFE_I32"}, // 457
                {amdgpu_gfx90a_op_V_BFI_B32,"V_BFI_B32"}, // 458
                {amdgpu_gfx90a_op_V_FMA_F32,"V_FMA_F32"}, // 459
                {amdgpu_gfx90a_op_V_FMA_F64,"V_FMA_F64"}, // 460
                {amdgpu_gfx90a_op_V_LERP_U8,"V_LERP_U8"}, // 461
                {amdgpu_gfx90a_op_V_ALIGNBIT_B32,"V_ALIGNBIT_B32"}, // 462
                {amdgpu_gfx90a_op_V_ALIGNBYTE_B32,"V_ALIGNBYTE_B32"}, // 463
                {amdgpu_gfx90a_op_V_MIN3_F32,"V_MIN3_F32"}, // 464
                {amdgpu_gfx90a_op_V_MIN3_I32,"V_MIN3_I32"}, // 465
                {amdgpu_gfx90a_op_V_MIN3_U32,"V_MIN3_U32"}, // 466
                {amdgpu_gfx90a_op_V_MAX3_F32,"V_MAX3_F32"}, // 467
                {amdgpu_gfx90a_op_V_MAX3_I32,"V_MAX3_I32"}, // 468
                {amdgpu_gfx90a_op_V_MAX3_U32,"V_MAX3_U32"}, // 469
                {amdgpu_gfx90a_op_V_MED3_F32,"V_MED3_F32"}, // 470
                {amdgpu_gfx90a_op_V_MED3_I32,"V_MED3_I32"}, // 471
                {amdgpu_gfx90a_op_V_MED3_U32,"V_MED3_U32"}, // 472
                {amdgpu_gfx90a_op_V_SAD_U8,"V_SAD_U8"}, // 473
                {amdgpu_gfx90a_op_V_SAD_HI_U8,"V_SAD_HI_U8"}, // 474
                {amdgpu_gfx90a_op_V_SAD_U16,"V_SAD_U16"}, // 475
                {amdgpu_gfx90a_op_V_SAD_U32,"V_SAD_U32"}, // 476
                ...
                {amdgpu_gfx90a_op_V_PERM_B32,"V_PERM_B32"}, // 493
                {amdgpu_gfx90a_op_V_FMA_LEGACY_F16,"V_FMA_LEGACY_F16"}, // 494
                {amdgpu_gfx90a_op_V_DIV_FIXUP_LEGACY_F16,"V_DIV_FIXUP_LEGACY_F16"}, // 495
                {amdgpu_gfx90a_op_V_CVT_PKACCUM_U8_F32,"V_CVT_PKACCUM_U8_F32"}, // 496
                {amdgpu_gfx90a_op_V_MAD_U32_U16,"V_MAD_U32_U16"}, // 497
                {amdgpu_gfx90a_op_V_MAD_I32_I16,"V_MAD_I32_I16"}, // 498
                {amdgpu_gfx90a_op_V_XAD_U32,"V_XAD_U32"}, // 499
                {amdgpu_gfx90a_op_V_MIN3_F16,"V_MIN3_F16"}, // 500
                {amdgpu_gfx90a_op_V_MIN3_I16,"V_MIN3_I16"}, // 501
                {amdgpu_gfx90a_op_V_MIN3_U16,"V_MIN3_U16"}, // 502
                {amdgpu_gfx90a_op_V_MAX3_F16,"V_MAX3_F16"}, // 503
                {amdgpu_gfx90a_op_V_MAX3_I16,"V_MAX3_I16"}, // 504
                {amdgpu_gfx90a_op_V_MAX3_U16,"V_MAX3_U16"}, // 505
                {amdgpu_gfx90a_op_V_MED3_F16,"V_MED3_F16"}, // 506
                {amdgpu_gfx90a_op_V_MED3_I16,"V_MED3_I16"}, // 507
                {amdgpu_gfx90a_op_V_MED3_U16,"V_MED3_U16"}, // 508
                {amdgpu_gfx90a_op_V_LSHL_ADD_U32,"V_LSHL_ADD_U32"}, // 509
                {amdgpu_gfx90a_op_V_ADD_LSHL_U32,"V_ADD_LSHL_U32"}, // 510
                {amdgpu_gfx90a_op_V_ADD3_U32,"V_ADD3_U32"}, // 511
                {amdgpu_gfx90a_op_V_LSHL_OR_B32,"V_LSHL_OR_B32"}, // 512
                {amdgpu_gfx90a_op_V_AND_OR_B32,"V_AND_OR_B32"}, // 513
                {amdgpu_gfx90a_op_V_OR3_B32,"V_OR3_B32"}, // 514
                {amdgpu_gfx90a_op_V_MAD_F16,"V_MAD_F16"}, // 515
                {amdgpu_gfx90a_op_V_MAD_U16,"V_MAD_U16"}, // 516
                ...
                {amdgpu_gfx90a_op_V_MAX_F64,"V_MAX_F64"}, // 643
                {amdgpu_gfx90a_op_V_LDEXP_F64,"V_LDEXP_F64"}, // 644
                {amdgpu_gfx90a_op_V_MUL_LO_U32,"V_MUL_LO_U32"}, // 645
                {amdgpu_gfx90a_op_V_MUL_HI_U32,"V_MUL_HI_U32"}, // 646
                {amdgpu_gfx90a_op_V_MUL_HI_I32,"V_MUL_HI_I32"}, // 647
                {amdgpu_gfx90a_op_V_LDEXP_F32,"V_LDEXP_F32"}, // 648
                {amdgpu_gfx90a_op_V_READLANE_B32,"V_READLANE_B32"}, // 649
                {amdgpu_gfx90a_op_V_WRITELANE_B32,"V_WRITELANE_B32"}, // 650
                ...
                {amdgpu_gfx90a_op_V_TRIG_PREOP_F64,"V_TRIG_PREOP_F64"}, // 658
                {amdgpu_gfx90a_op_V_BFM_B32,"V_BFM_B32"}, // 659
                {amdgpu_gfx90a_op_V_CVT_PKNORM_I16_F32,"V_CVT_PKNORM_I16_F32"}, // 660
                {amdgpu_gfx90a_op_V_CVT_PKNORM_U16_F32,"V_CVT_PKNORM_U16_F32"}, // 661
                {amdgpu_gfx90a_op_V_CVT_PKRTZ_F16_F32,"V_CVT_PKRTZ_F16_F32"}, // 662
                {amdgpu_gfx90a_op_V_CVT_PK_U16_U32,"V_CVT_PK_U16_U32"}, // 663
                ...
                {amdgpu_gfx90a_op_V_SUB_I16,"V_SUB_I16"}, // 671
                {amdgpu_gfx90a_op_V_PACK_B32_F16,"V_PACK_B32_F16"}, // 672
                {amdgpu_gfx90a_op_V_MUL_LEGACY_F32,"V_MUL_LEGACY_F32"}, // 673
            }; // end ENC_VOP3_insn_table
            const amdgpu_gfx90a_insn_entry ENC_VOP2_insn_table[62] = 
            {
                {amdgpu_gfx90a_op_V_CNDMASK_B32,"V_CNDMASK_B32"}, // 0
                {amdgpu_gfx90a_op_V_ADD_F32,"V_ADD_F32"}, // 1
                {amdgpu_gfx90a_op_V_SUB_F32,"V_SUB_F32"}, // 2
                {amdgpu_gfx90a_op_V_SUBREV_F32,"V_SUBREV_F32"}, // 3
                {amdgpu_gfx90a_op_V_FMAC_F64,"V_FMAC_F64"}, // 4
                ...
                {amdgpu_gfx90a_op_V_MUL_U32_U24,"V_MUL_U32_U24"}, // 8
                {amdgpu_gfx90a_op_V_MUL_HI_U32_U24,"V_MUL_HI_U32_U24"}, // 9
                {amdgpu_gfx90a_op_V_MIN_F32,"V_MIN_F32"}, // 10
                {amdgpu_gfx90a_op_V_MAX_F32,"V_MAX_F32"}, // 11
                {amdgpu_gfx90a_op_V_MIN_I32,"V_MIN_I32"}, // 12
                {amdgpu_gfx90a_op_V_MAX_I32,"V_MAX_I32"}, // 13
                {amdgpu_gfx90a_op_V_MIN_U32,"V_MIN_U32"}, // 14
                {amdgpu_gfx90a_op_V_MAX_U32,"V_MAX_U32"}, // 15
                {amdgpu_gfx90a_op_V_LSHRREV_B32,"V_LSHRREV_B32"}, // 16
                {amdgpu_gfx90a_op_V_ASHRREV_I32,"V_ASHRREV_I32"}, // 17
                {amdgpu_gfx90a_op_V_LSHLREV_B32,"V_LSHLREV_B32"}, // 18
                ...
                {amdgpu_gfx90a_op_V_ADDC_CO_U32,"V_ADDC_CO_U32"}, // 28
                {amdgpu_gfx90a_op_V_SUBB_CO_U32,"V_SUBB_CO_U32"}, // 29
                {amdgpu_gfx90a_op_V_SUBBREV_CO_U32,"V_SUBBREV_CO_U32"}, // 30
                ...
                {amdgpu_gfx90a_op_V_MUL_LO_U16,"V_MUL_LO_U16"}, // 41
                {amdgpu_gfx90a_op_V_LSHLREV_B16,"V_LSHLREV_B16"}, // 42
                {amdgpu_gfx90a_op_V_LSHRREV_B16,"V_LSHRREV_B16"}, // 43
                {amdgpu_gfx90a_op_V_ASHRREV_I16,"V_ASHRREV_I16"}, // 44
                {amdgpu_gfx90a_op_V_MAX_F16,"V_MAX_F16"}, // 45
                {amdgpu_gfx90a_op_V_MIN_F16,"V_MIN_F16"}, // 46
                {amdgpu_gfx90a_op_V_MAX_U16,"V_MAX_U16"}, // 47
                {amdgpu_gfx90a_op_V_MAX_I16,"V_MAX_I16"}, // 48
                {amdgpu_gfx90a_op_V_MIN_U16,"V_MIN_U16"}, // 49
                {amdgpu_gfx90a_op_V_MIN_I16,"V_MIN_I16"}, // 50
                {amdgpu_gfx90a_op_V_LDEXP_F16,"V_LDEXP_F16"}, // 51
                ...
                {amdgpu_gfx90a_op_V_DOT2C_F32_F16,"V_DOT2C_F32_F16"}, // 55
                {amdgpu_gfx90a_op_V_DOT2C_I32_I16,"V_DOT2C_I32_I16"}, // 56
                {amdgpu_gfx90a_op_V_DOT4C_I32_I8,"V_DOT4C_I32_I8"}, // 57
                {amdgpu_gfx90a_op_V_DOT8C_I32_I4,"V_DOT8C_I32_I4"}, // 58
                {amdgpu_gfx90a_op_V_FMAC_F32,"V_FMAC_F32"}, // 59
                {amdgpu_gfx90a_op_V_PK_FMAC_F16,"V_PK_FMAC_F16"}, // 60
                {amdgpu_gfx90a_op_V_XNOR_B32,"V_XNOR_B32"}, // 61
            }; // end ENC_VOP2_insn_table
            const amdgpu_gfx90a_insn_entry ENC_VOP2_LITERAL_insn_table[38] = 
            {
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 0
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 1
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 2
                ...
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 22
                {amdgpu_gfx90a_op_V_MADMK_F32,"V_MADMK_F32"}, // 23
                {amdgpu_gfx90a_op_V_MADAK_F32,"V_MADAK_F32"}, // 24
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 25
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 26
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 27
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 28
                ...
                {amdgpu_gfx90a_op_V_MADMK_F16,"V_MADMK_F16"}, // 36
                {amdgpu_gfx90a_op_V_MADAK_F16,"V_MADAK_F16"}, // 37
            }; // end ENC_VOP2_LITERAL_insn_table
            const amdgpu_gfx90a_insn_entry ENC_VOP3B_insn_table[490] = 
            {
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 0
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 1
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 2
            ...
            const amdgpu_gfx90a_insn_entry ENC_VOP3P_insn_table[90] = 
            {
                {amdgpu_gfx90a_op_V_PK_MAD_I16,"V_PK_MAD_I16"}, // 0
                {amdgpu_gfx90a_op_V_PK_MUL_LO_U16,"V_PK_MUL_LO_U16"}, // 1
                {amdgpu_gfx90a_op_V_PK_ADD_I16,"V_PK_ADD_I16"}, // 2
                {amdgpu_gfx90a_op_V_PK_SUB_I16,"V_PK_SUB_I16"}, // 3
                {amdgpu_gfx90a_op_V_PK_LSHLREV_B16,"V_PK_LSHLREV_B16"}, // 4
                {amdgpu_gfx90a_op_V_PK_LSHRREV_B16,"V_PK_LSHRREV_B16"}, // 5
                {amdgpu_gfx90a_op_V_PK_ASHRREV_I16,"V_PK_ASHRREV_I16"}, // 6
                {amdgpu_gfx90a_op_V_PK_MAX_I16,"V_PK_MAX_I16"}, // 7
                {amdgpu_gfx90a_op_V_PK_MIN_I16,"V_PK_MIN_I16"}, // 8
                {amdgpu_gfx90a_op_V_PK_MAD_U16,"V_PK_MAD_U16"}, // 9
                {amdgpu_gfx90a_op_V_PK_ADD_U16,"V_PK_ADD_U16"}, // 10
                {amdgpu_gfx90a_op_V_PK_SUB_U16,"V_PK_SUB_U16"}, // 11
                {amdgpu_gfx90a_op_V_PK_MAX_U16,"V_PK_MAX_U16"}, // 12
                {amdgpu_gfx90a_op_V_PK_MIN_U16,"V_PK_MIN_U16"}, // 13
                {amdgpu_gfx90a_op_V_PK_FMA_F16,"V_PK_FMA_F16"}, // 14
                {amdgpu_gfx90a_op_V_PK_ADD_F16,"V_PK_ADD_F16"}, // 15
            ...
            const amdgpu_gfx90a_insn_entry ENC_VOP3P_MFMA_insn_table[112] = 
            {
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 0
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 1
                {amdgpu_gfx90a_op_S_NOP,"S_NOP"}, // 2
                ...
                {amdgpu_gfx90a_op_V_MFMA_F32_32X32X8BF16_1K,"V_MFMA_F32_32X32X8BF16_1K"}, // 102
                ...
                {amdgpu_gfx90a_op_V_MFMA_F64_16X16X4F64,"V_MFMA_F64_16X16X4F64"}, // 110
                {amdgpu_gfx90a_op_V_MFMA_F64_4X4X4F64,"V_MFMA_F64_4X4X4F64"}, // 111
...
#endif //INSTRUCTION_DECODER_GFX90A_H
