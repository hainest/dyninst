...
namespace Dyninst { namespace DyninstAPI {
  ...
  public:
    ...
    void emitAddrSpecLoad(const BPatch_addrSpec_NP *as, Dyninst::Register dest,
                          int stackShift, codeGen &gen) override;
    ...
    Register emitCall(opCode, codeGen &,
    ...
    void emitGetParam(Register, Register, instPoint::Type, opCode, bool,
                      codeGen &) override;
    ...
    codeBufIndex_t emitIf(Register, Register, Dyninst::DyninstAPI::RegControl,
                          codeGen &) override;

    void emitImm(opCode op, Dyninst::Register src, Dyninst::RegValue src2imm,
                 Dyninst::Register dst, codeGen &gen, bool isSigned = true) override;
    ...
    void emitLoadShared(opCode op, Register dest, const image_variable *var,
                        bool is_local, int size, codeGen &gen, Address offset) override;
    ...
    void emitStoreShared(Register source, const image_variable *var, bool is_local,
                         int size, codeGen &gen) override;

    void emitTimesImm(Register, Register, RegValue, codeGen &) override;

    void emitV(opCode op, Dyninst::Register src1, Dyninst::Register src2,
               Dyninst::Register dst, codeGen &gen, int size = 4,
               AddressSpace *proc = NULL, bool s = true) override;

    void emitVload(opCode op, Dyninst::Address src1, Dyninst::Register src2,
                   Dyninst::Register dst, codeGen &gen, int size = 4,
                   AddressSpace *proc = NULL) override;

    void emitVstore(opCode op, Dyninst::Register src1, Dyninst::Register src2,
                    Dyninst::Address dst, codeGen &gen, int size = 4,
                    AddressSpace *proc = NULL) override;
