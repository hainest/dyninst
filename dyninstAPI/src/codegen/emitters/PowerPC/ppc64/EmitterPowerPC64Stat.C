...
namespace Dyninst { namespace DyninstAPI {
  ...
  bool EmitterPowerPC64Stat::emitCallInstruction(codeGen &gen, func_instance *callee,
                                                 bool, Address) {
  ...
  bool EmitterPowerPC64Stat::emitPLTCommon(func_instance *callee, bool call,
                                           codeGen &gen) {
  ...
  bool EmitterPowerPC64Stat::emitTOCCommon(block_instance *block, bool call,
                                           codeGen &gen) {
